...
Ctrl+K
Login/Sign up
# What is IOTA Coin? All You Need to Know Briefly Explained
25 October 2019
5 min read
![What is IOTA Coin? All You Need to Know Briefly Explained](https://wp-asset.groww.in/wp-content/uploads/2018/02/18123419/luca-bravo-205341-unsplash.jpg)
...
IOTA stands for Internet of Things Application. IOTA is a cryptocurrency with no blocks, chains or fees but it uses Tangle, a new technology. To power the Internet of Things this network is designed to handle large amount of micropayments.
IOTA has four unique advantages when compared toanother blockchain cryptocurrency.
  1. No Fee
  2. Scalable
  3. Decentralized
  4. Modular
...
Each user before sending his or her own transaction verifies the past two transactions, so the cost of the transaction becomes only the cost of electricity utilized for verifying the past transactions.
...
To perform an attack on IOTA, three things are required because of its network topology :
  1. A full view of the network
  2. Pairing with a certain percentage of nodes
  3. Percentage of a network hash rate


To propagate the rogue hashing power effectively, a full view of the network is required and that hashing power has to be paired with a high percentage of nodes for effective attack otherwise the network will ignore the threat seeing the anomaly.
...
Comparing the price of $1.50 of on December 3, 2017, there was 3.67x surge in only 3 days and price increased to $5.50 on December 6, 2017. After which, IOTA like all cryptocurrency faced a low point in the beginning of year 2018.
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Crypto](https://groww.in/blog/category/crypto)>What is IOTA Coin? All You Need to Know Briefly Explained
