...
11 April 2025
7 min read
![What is Margin Shortfall in MTF?](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_03_24_T165926_073_11zon_0a661d0141.jpg)
...
For instance, you want to buy shares worth ₹1,00,000, but you only have ₹25,000. With a **[Margin Trading Facility (MTF)](https://groww.in/stocks/mtf)** , your broker can lend you the remaining ₹75,000, provided you maintain a margin of 25%—this means your own money should cover at least 25% of the total investment.
...
---  
[**Learn More About Margin Trading Facility**](https://groww.in/p/margin-trading)
## **Undertanding Margin Shortfall with Examples**
Let’s have a look at different cases to understand how margin shortfall can occur. 
  ...
  * **Amount Funded by Groww** : ₹75,000**Haircut (HC)** : 25%
...
**_Note: You can refer to the MTF Fund tracker (MTF Summary) to track the Amount Paid by you, the Amount funded by Groww, and the total interest deducted at the scrip level._**
...
**Check all the[Stocks Available for MTF](https://groww.in/stocks/mtf/list)**
## **Consequences of Margin Shortfall**
If you do not cover a margin shortfall in time, you could face the following issues:
  * **Forced Liquidation:** If the shortfall persists for 5 consecutive trading days, your broker may sell off a portion of your holdings on the 6th day to recover the deficit.
...
**Also check** [**Risk Policy**](https://groww.in/pages/risk-policy)
