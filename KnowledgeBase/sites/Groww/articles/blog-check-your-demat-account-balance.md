...
26 June 2025
4 min read
![How to Check Your Demat Account Balance Online](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_06_26_T160453_560_11zon_9227d19bfe.jpg)
...
If you are an investor, it is important to conduct periodic reviews of your holdings. Keeping track of your investments and their value can help you monitor the performance, make necessary changes, and aid you while making financial decisions. A demat account is mandatory for investing and trading in stocks. Since your stocks are held in the demat account, it is important to know your demat account balance. In this blog, we will look at how to check your demat account balance online.
## Demat Account Balance
A [demat account](https://groww.in/open-demat-account) is a prerequisite to invest and trade in stocks. To invest in shares, an investor needs to open a demat account with a depository participant (DP) such as a broker or bank. The DP acts as a bridge which connects the investor to a depository like [CDSL](https://groww.in/blog/cdsl-demat-account) or [NSDL](https://groww.in/blog/nsdl-demat-account).
When you purchase shares, they are stored in an electronic format in your demat account. The demat account is similar to a bank account for your investments. The demat account balance is the total value of your holdings, and a demat account balance gives an investor insights into the value of their investments.
Whenever you purchase or sell securities, your demat account balance is also updated to reflect the latest value of your holdings. In some cases, an investor might have several demat accounts, and with the help of a consolidated account statement (CAS), one can check the demat account balance of all accounts.
## Three Ways to Check Your Demat Account Balance
### Broker’s App or Website
One of the most convenient and efficient ways to check your demat account balance is through the app or online portal of your broker or depository participant. In most cases, the depository participant with whom you opened your demat account will have a digital platform that will allow you to access your demat account balance. The platform may also provide detailed insights and graphs about your investments.
### CDSL’s Easiest Portal
If your demat account is linked with the Central Depository Services Limited (CDSL), then you can make use of its online facility known as Easiest. The electronic access to securities information and execution of secured transactions (Easiest) is a digital portal that offers several services, including checking your demat account balance online. Here’s how you can check the demat account balance through CDSL Easiest:
  * Your demat account should be linked with CDSL.
  * Register for CDSL Easiest by visiting the CDSL website and entering the necessary information, such as your 8-digit DP ID and your 16-digit beneficiary owner ID. Set up a password that you will use to log in to the portal.
  * Investors also need to provide basic information such as the PAN card number and date of birth.
  * During the log-in process, OTP verification will be done through the registered mobile number.
  * After logging in to the CDSL Easiest portal, you can access all features of the online facility and check your demat account balance.


### NSDL’s IDeAS
If your demat account is linked with the National Securities Depository Limited (NSDL), you can check your demat account balance through its online facility, internet-based demat account statement (IDeAs).
To view holdings in a demat account through NSDL’s IDeAS portal, an investor needs to register for it first.
  * Visit the NSDL website and navigate to IDeAS under the value-added services section of the services tab.
  * Click on register for IDeAS and enter your DP ID, Client ID, and mobile number.
  * Next, create a username and password that you will use to log in to the portal.
  * After completing the registration process, you can log in to the IDeAS portal.
  * In the IDeAS portal, you can view the statement of holdings to check your demat account balance.


## Demat Account Balance through SMS or E-Mail Alerts
Investors can check their demat account balance by receiving alerts and updates through SMS or emails. Brokers, depository participants, and depositories offer the service of providing regular updates about the demat account balance. These updates are sent tothe registered mobile number and email ID of the investor. It is important to note that one needs to enable these notifications to receive the demat account balance through SMS or email.
## Things to Check while Viewing Demat Balance
While accessing your demat account balance, there are certain things that one needs to check.
  * Ensure that you have access to your DP ID, client ID, and other login credentials.
  * Have access to the registered mobile number for OTP verification.
  * Verify if your personal details are correct and if you have access to the right demat account.
  * Keep a track of your past holdings and current holdings to ensure accuracy.
  * Be aware of any corporate actions like splits or bonus issues, and if they are reflected in your demat account statement.


## Common Issues while Checking Demat Account Balance
Here are some of the common issues that investors might face while trying to check the demat account balance online.
  * Entering the incorrect login credentials or details, such as DP ID or client ID.
  * Facing connectivity issues or website crashes while checking the demat balance.
  * The demat balance is not being updated. Be aware of the settlement cycle. Shares will reflect in your demat account after the settlement cycle.
  * Not keeping track of corporate actions like bonuses or splits can cause confusion.
  * Not being aware of any demat account charges or fees that might impact your demat account balance.


## Conclusion
As an investor, it is vital to keep a close eye on your investments and track their performance. Developments in technology have made it easier for one to view their demat account balance online. While checking your demat account balance, make sure you have the right login credentials and access to the correct demat account.
