...
Ctrl+K
Login/Sign up
# How to Withdraw or Transfer Your US Stocks portfolio From Groww?
13 September 2024
6 min read
![How to Withdraw or Transfer Your US Stocks portfolio From Groww?](https://cms-resources.groww.in/uploads/pexels_ivan_samkov_7621140_11zon_38c71f9d2f.jpg)
...
## **Solution 1: Withdrawing current holdings**
You can easily withdraw all your holdings in one go, here is a step by step process to do this:
  1. Login to [https://groww.in/](https://groww.in/) and open ‘US stocks tab’ where you can see all your holdings.
  2. Sell your holdings by selecting stocks one by one and clicking on the sell button
  3. Once your positions are liquidated, the amount will be reflected in your US$ wallet from where you can initiate a full withdrawal. 
  4. The withdrawal will be completed in 3-4 working days and you will be charged $30 on it by the US broker. The withdrawal charges on Groww still remain to be $9. The balance amount of 21$ will be refunded to your Groww (Indian) bank account within 10 days 


## **Solution 2: Automated Customer Account Transfer Service (ACATS)**
...
The process involved in the transfer of US stocks from Groww to an external platform might differ depending upon the platform you choose to migrate to. By following the steps mentioned below, you can initiate the process:
  1. Before requesting for ACAT, download the account statements from this [link](https://groww.in/user/profile/report). (You won't be able to download account statements once the ACAT is completed).
  2. Place a sell order of all the fractional shares on Groww that are present in your portfolio.
  3. Log on to the platform where you want to transfer your holdings and complete the onboarding process
  4. Contact their support team, ask them to initiate ACAT (Platform: Groww, Broker dealer: Viewtrade securities) and provide them with your account statement. These are the details you may need to share:
  ...
  * **Contra firm/ delivery firm emai** l - bocaops@viewtrade.com
...
## **Things to Note Before Initiating an ACAT:**
  ...
  5. All your whole shares will be transferred but fractional parts of shares and ESOPs will not be transferred. 
...
### [Vested](https://vestedfinance.com/)
...
### [ICICI Direct Global](https://www.icicidirect.com/global-investment-services):
...
You can choose the external platform based on the account opening charges, brokerage fee per trade, annual charges, and additional features.Please note: Charges and features are as per 17th May 2024 and are subject to change. We take no responsibility or liability for any incorrect information. 
## **Are There Any Tax Implications Involved during ACAT?**
Since you won't be liquidating your shares, no capital gains tax is involved in transferring shares from one broker to another. However, make sure that you download your account statement before requesting for ACAT to avoid any confusion later ([link](https://groww.in/user/profile/report))
## **Conclusion:**
