...
30 May 2024
3 min read
![How to Link Aadhaar Card to LPG Connection](https://cms-resources.groww.in/uploads/How_to_Link_Aadhaar_Card_to_LPG_Connection_64c436dcb2.png)
...
You might know that linking an Aadhaar Card can be done with a PAN Card, Driving License, Voter ID Card, LIC Policy, etc. But are you familiar with the fact that you can link your LPG Connection with your Aadhar Card too?
Well, yes, you can!
You can link your LPG Connection to your Aadhaar Card to secure your identity, combat any false claims, reduce any malicious act that hinders your LPG usage, and for many more ounce of reasons.
We have jotted this blog to let you know all the possible ways via which you can **link Aadhar with LPG online** and offline.
## **6 Ways to Link Aadhar with Gas Connection**
Here are the 6 different ways that can help you know **how to link Aadhaar with gas connection online** with detailed steps-
### **1) Linking Aadhar with LPG Online**
The steps entailed below describe how to link Aadhaar to LPG gas connection online-
**Step 1:** Open the website [https://rasf.uidai.gov.in/seeding/User/ResidentSelfSeedingpds.aspx](https://rasf.uidai.gov.in/seeding/User/ResidentSelfSeedingpds.aspx). Fill in the required details.
**Step 2:** In the Benefit Type, select ‘LPG’. Next, select the Scheme Name as per your LPG connection. For instance, it can be ‘IOCL’ for Indane connections.
**Step 3:** Next, you would have to choose the respective distributor name from the given list. Here you would also be required to enter your designated LPG consumer number.
**Step 4:** In this step, you will be asked to fill out your mobile number, email ID and also your Aadhaar Card number. Once done, finally, click on ‘Submit’.
**Step 5:** You will receive a One Time Password (OTP) on your registered mobile number and on your email address as well. Enter the same to finish the process.
**Step 6:** Once you have successfully submitted your request, the details that you provided will be verified by authorized officials. Once the verification is completed, you will receive a notification ascertaining the same on your email address and registered mobile number.
### **2) Application Submission to the Distributor (Offline Method)**
You can submit the application to the distributor by following the listed steps-
**Step 1:** Download the subsidy application form from the website of the LPG provider.
**Step 2:** Download and print the form and fill it with the required details.
**Step 3:** Mark a visit to the nearest office of your LPG distributor and submit your application form.
### **3) Through Call Centre**
You can link your LPG to [Aadhar Card](https://groww.in/p/aadhaar-card) by connecting to a call centre too. Simply dial 18000-2333-555 and connect with an operator who will guide you through the process.
### **4) Via SMS**
Another way to link Aadhar LPG is via SMS. Simply register your mobile number with your LPG distributor. Send an SMS from that registered mobile number.
### **5) Through IVRS**
You can now use IVRS to complete the linking of Aadhaar to LPG. Each district carries a distinct IVRS, and customers can avail of the number of their respective districts provided in the list.
  * **Bharat Gas Customers**


Visit [https://my.ebharatgas.com/bharatgas/BookCylinder/IVRS](https://my.ebharatgas.com/bharatgas/BookCylinder/IVRS) and place a call on the IVRS number mentioned on the website. Complete the process as instructed by the administrator.
  * **Indane Gas Customers**


Forthe **Indane Gas Aadhar Link online,** visit the official web portal. Find your District Number, call the same and follow the steps as instructed.
  * **HP Gas Customers**


For **HP Gas Aadhar Card Link online,** visit [www.hindustanpetroleum.com/hpanytime](http://www.hindustanpetroleum.com/hpanytime). Call the provided IVRS number and complete the instructed steps as communicated by the operator.
### **6) Linking Gas Connection to Aadhar by Post**
Visit the official website and download the form. Fill it duly with the required information and post it to the address mentioned in the form.
## **Summing Up Gas Aadhaar Link Online Procedure**
Currently, it is not mandatory to link your Aadhaar Card to LPG Connection, although if you consider linking the same now, you could save yourself from prospective fraud, larceny, and any malicious activity that can be done under your name.
Hence, refer to the aforementioned ways and choose the one that best fits your feasibility to complete the linking process of Aadhar and LPG Connection.
**You May Also Be Interested to Know-**  
---  
1. |  [How to Link Aadhaar Card to Bank Account](https://groww.in/p/aadhaar-card/link-aadhaar-card-to-bank-account)  
2. |  [How to Link Aadhaar with PAN to File Income Tax Returns](https://groww.in/blog/how-to-link-aadhaar-with-pan-to-file-income-tax-returns)  
3. |  [How to Link Aadhaar with Mobile Number Online IVRS/OTP](https://groww.in/blog/how-to-link-aadhar-with-mobile-number-online)  
4. |  [How to Link Aadhaar Card to Voter ID](https://groww.in/blog/how-to-link-aadhaar-to-voter-id)  
5. |  [How to Link Aadhaar with Driving Licence](https://groww.in/blog/how-to-link-aadhaar-with-driving-licence)  
...
Related Posts
[How to Link Aadhaar with LIC Policy](https://groww.in/blog/how-to-link-aadhaar-with-lic-policy)[How to Link Aadhaar with Driving Licence](https://groww.in/blog/how-to-link-aadhaar-with-driving-licence)[How to Link Aadhaar Card to Voter ID](https://groww.in/blog/how-to-link-aadhaar-to-voter-id)[How to Apply for New Aadhar Card Online](https://groww.in/blog/how-to-apply-for-new-aadhar-card-online)[How to Change your Mobile Number in Aadhaar Card?](https://groww.in/blog/how-to-change-your-mobile-number-in-aadhaar-card)
All Topics
[
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Aadhar](https://groww.in/blog/category/aadhar)>How to Link Aadhaar Card to LPG Connection
