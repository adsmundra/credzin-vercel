...
20 May 2025
5 min read
![Basic Service Demat Account \(BSDA\)](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_05_20_T110238_489_11zon_c52de33f1c.jpg)
...
Now that you have an idea of what a BSDA means, it is important to look at some of its key features. These include the following: 
  ...
  * No AMC for smaller holdings below **₹** 50,000
...
The eligibility criteria for BSDA accounts include the following: 
  ...
  * The total value of securities in the account should not cross **₹** 2 lakh at any point 
  * BSDA accounts cannot be joint accounts, and while any full-service demat account may be converted to a BSDA, it is subject to SEBI verification 
...
There are several conditions stipulated by SEBI for BSDA accounts, including: 
  * Only one BSDA is allowed for each PAN
  * The customer should be the first/sole holder of the account, and he/she cannot have any other such account across all DPs
  * The total value of securities in these accounts cannot cross **₹** 2 lakh at any given time. If it does, then the account may be converted into a regular demat account with standard charges.
  * There will be no AMCs in case the holding value is less than **₹** 50,000, while it is a maximum of **₹** 100 per year in case the value is up to **₹** 2,00,000. Beyond this threshold, DPs may levy regular charges from that date.
...
India has several types of demat accounts, including FSDA (full-service demat accounts), BSDA (basic service demat accounts), repatriable demat accounts, and non-repatriable demat accounts. 
### What is the difference between a BSDA and a non-BSDA account?
A BSDA is tailored for smaller investors with lower holdings and maintenance costs, while non-BSDA accounts have no holding limits and incur higher charges as a result. 
### How can I convert my Demat account to BSDA?
You can submit an application and declaration to your DP at least 15 days before the next billing cycle. Make sure you meet all the requirements before applying. 
### How do I know if my account is a BSDA account?
If you have only one demat account under your PAN as the first/sole holder with the value of your holdings lower than ₹2 lakh, it is a BSDA account. You can contact your DP for more information in this regard. 
### Disclaimer
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Stocks](https://groww.in/blog/category/stocks)>Basic Service Demat Account (BSDA)
