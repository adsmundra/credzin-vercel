...
Ctrl+K
Login/Sign up
# Patil Automation IPO Allotment Status: Check Latest GMP, Steps To Verify Status
19 June 2025
2 min read
![Patil Automation IPO Allotment Status: Check Latest GMP, Steps To Verify Status](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_06_19_T102318_394_11zon_364f2260fa.jpg)
...
The bidding window for Patil Automation SME IPO was open from June 16, 2025, to June 18, 2025. The basis of allotment will be finalised today, June 19, 2025. Here’s how you can check the IPO allotment status on NSE and registrar’s website. 
## **Check Patil Automation IPO Allotment Status Online On NSE**
    * Visit the NSE’s IPO allotment verification status page [**here**](https://www.nseindia.com/invest/check-trades-bids-verify-ipo-bids). 
    * Select **_“Equity & SME IPO bid details.”_**
    * In Select Symbol, select **_“PATILAUTOM.”_**
...
## **Check Patil Automation IPO Allotment Status on Purva Shareregistry Private Limited (Registrar to the issue)**
  * Visit the IPO allotment status page [**here**](https://www.purvashare.com/investor-service/ipo-query). 
  * Select **_“PATIL AUTOMATION LIMITED_** ” under **_“Select Company.”_**
  * Enter your Application Number or PAN 
  * Click **_Search._**


## **IPO Details**
Patil Automation IPO is a book-building issue of ₹66.10 crores, consisting entirely of a fresh issue of 55.08 lakh equity shares. The price band is set at ₹120 per share. The tentative listing on NSE Emerge is June 23, 2025. 
Seren Capital Private Limited is the book-running lead manager, and Purva Shareregistry (India) Private Limited is the registrar for the issue. 
## **Use of Proceeds**
...
## **Patil Automation IPO - Overall Subscription Status**
(June 18, 2025, end of the day)
**Category** |  **Subscription (times)**  
---|---  
Qualified Institutional Investors (QIBs) |  82.92  
Non-Institutional Investors (NIIs) |  258.18  
Retail Individual Investors(RIIs) |  44.77  
Total  |  101.42  
## **Patil Automation IPO GMP Details**
As of 19 June 2025, Oswal Pumps IPO GMP stood at ₹22. The expected listing price is ₹142, i.e., an 18.33% gain per share over the upper price band.
**_Source: Business Standard Report dated 19 June, 2025_** **_Disclaimer: The GMP (Grey Market Premium) price is an unauthenticated market related news and has no discernible basis. The same quoted above is as per news appeared in the media report and is for information purposes only. The investor shall do their own study/research before using the same for taking any decision to invest. We neither engage in, trade, or deal in the grey market nor we recommend or endorse trading in the grey market._**  
---  
## **Patil Automation Business Overview**
Patil Automation provides industrial automation solutions to the automotive sector. The company offers end-to-end automation services, including designing, manufacturing, testing, and installing customised systems. 
They primarily cater to Automotive Original Equipment Manufacturers (OEMs), Tier I suppliers, and component and sub-component manufacturers. 
