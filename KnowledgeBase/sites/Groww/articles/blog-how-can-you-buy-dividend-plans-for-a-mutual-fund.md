...
12 July 2023
4 min read
![How Can You Buy Dividend Plans for a Mutual Fund?](https://wp-asset.groww.in/wp-content/uploads/2018/08/18123049/Untitled-design-30.png)
...
## How to Buy a Dividend Plan for a Mutual Fund?
In a [mutual fund](https://groww.in/mutual-funds), the dividend plan refers to the payment of profits to investors in the form of dividends. This payment can be made regularly or at the end of the investment period.
Here's basically how you need to buy a dividend plan for a mutual fund in India:
  1. **Research:** Choose the mutual fund you want to invest in and research the dividend plans offered by the fund.
  2. **Check the NAV** : Check the fund's [Net Asset Value](https://groww.in/p/nav) (NAV) and ensure it is within your budget.
  3. **Register with the fund house:** Register yourself with the fund house by filling up the application form and submitting it along with KYC documents.
  4. **Select the dividend plan** : Choose the one you want to invest in and mention it in the application form.
  5. **Investment amount:** Mention the amount you want to invest in the fund.
  6. **Payment:** Make the payment through net banking or by cheque.
  7. **Confirmation:** Once the payment is received, you will get a confirmation of your investment in the fund.


## **Steps to Buy a Dividend Plan for a Mutual Fund**
  1. First, to buy a dividend plan for a mutual fund, you will need a PAN, bank account, and KYC (know your client) compliance.
  ...
  3. The customer must complete a KYC form, which is not complex.


This process is uniform across various [SEBI](https://groww.in/p/sebi-securities-and-exchange-board-of-india)-regulated intermediaries in different security markets, such as mutual funds, depository participants, stockbroking, etc.
...
Documents required to be submitted along with the KYC application are as follows.
  ...
  * Identity proof such as a copy of [PAN card](https://groww.in/p/pan-card)/ UID ([Aadhaar](https://groww.in/p/aadhaar-card))/passport/ voter ID /driving license
...
### **3. AMC**
Instead of going to intermediaries or IFAs, you can invest directly in a mutual fund scheme through the [AMC](https://groww.in/mutual-funds/amc).
...
If you have a [Demat account](https://groww.in/open-demat-account), you can buy and sell mutual fund schemes through them
### **6. Online Portals**
