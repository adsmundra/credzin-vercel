...
'''
### ToDos
Read all the bank CSVs and create a single pandas df
Then add more feature columns to the df using below code 
Save it as a single big excel file for all the 400  - StructuredCardData
Create another excel file with cards for each bank in different sub-sheets/tabs - StructuredCardData
Parse csv data for all the 400 cards, chunk it, embed it and prepare for Qdrant load 
Load in Qdrant
'''
