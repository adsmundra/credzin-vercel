...
07 April 2025
4 min read
![CDSL Demat Account - Meaning, Use and Registration](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_04_03_T154406_287_11zon_12c4406f46.jpg)
...
Please note that investors are now required to hold a [demat account](https://groww.in/open-demat-account) (either with NSDL or CDSL) to trade in the Indian stock market. 
...
One can register for CDSL EASI by following the steps below:
  * Visit the [official website of CDSL](https://www.cdslindia.com/).
...
**_To know more, read our blog on_**[** _What is CDSL Easi and How to Register For It?_**](https://groww.in/blog/what-is-cdsl-easi-and-how-to-register)
