...
Ctrl+K
Login/Sign up
# 8 Things You Need to Know About Ripple XRP
20 April 2022
6 min read
![8 Things You Need to Know About Ripple XRP](https://wp-asset.groww.in/wp-content/uploads/2018/01/18123524/Ripple-XRP-things-you-need-to-know.016.jpeg)
...
As with so many other [cryptocurrencies](https://groww.in/p/cryptocurrency), Ripple has recently shot in popularity with new investors betting their money on this coin.
...
## 1. Ripple Facts
Ripple price in INR | Rs 68.14  
---|---  
Volume | $1.066  
Market Capitalisation | $70,984,055,721 USD  
Maximum Supply | 100,000,000,000 XRP  
## 2. Ripple XRP Rate Chart [![](https://wp-asset.groww.in/wp-content/uploads/2018/01/18123527/chart-1-1024x683.png)](https://wp-asset.groww.in/wp-content/uploads/2018/01/18123527/chart-1.png)
...
## 4. XRP Ripple: Risk
Unfavorable government regulations or even a ban of cryptocurrencies in certain countries pose a huge question mark on the existence of cryptocurrencies.
Unlike other cryptocurrencies, the XRP coins cannot be mined. The protocol has XRP units that can come in the market to 100 billion units.
...
Now the prices of the coin are strongly under the control of the founders they can anytime flood the markets with extra coins making the markets crash.
Further, a fixed supply makes XRP a scarce resource. And the prices are a function of demand and supply. With supply being constant and speculative demand rising on an ever-increasing curve because of rumors in the market.
This may make Ripple a bubble that may burst the very moment the speculation ends and people begin to lose interest in XRP ownership.
...
One such instrument is the [Mutual fund](https://groww.in/mutual-funds).
...
If you want high returns and are open to risk then you can try investing in small-cap funds which is still better than diving into the uncharted waters of cryptocurrency.
...
Ripple uses a medium known as Gateway that serves as the link in the trust chain between two parties wanting to make a transaction. The Gateway acts as the credit intermediary that receives and sends currencies to public addresses over the Ripple network.
Anyone or any business can register and open a gateway that authorizes the registrant to act as the middleman for exchanging currencies, maintaining liquidity, and transferring payments on the network.
The digital currency, XRP, acts as a bridge currency to other currencies. It does not discriminate between one cryptocurrency and another, and thus, makes it easy for any currency to be exchanged for another.
Each currency in the ecosystem has its own gateway e.g. CADBluzelle, BTCbitstamp, and USDsnapswap.
...
But even though financial transaction history is publicly recorded and made available on the blockchain, the data is not linked to the ID or account of any individual or business.
However, the public record of all dealings, makes the information susceptible to de-anonymisation measures.
## 7. Advantages: Ripple
  1. Ripple improves on some of the drawbacks attributed to traditional banks.
  2. Transactions are settled within seconds on the Ripple network even though the platform handles millions of transactions frequently. This is unlike banks which could take days or weeks to complete a wire transfer.
  3. The fee to conduct transactions on Ripple is also minimal, with the minimum transaction cost required for a standard transaction set at 0.00001 XRP, compared to the large fees charged by banks for conducting cross-border payments.


## 8. History of XRP Ripple
...
Happy investing!
_Disclaimer: The views expressed here are those of the author. Mutual funds are subject to market risks. Please read the offer document carefully before investing._
