...
17 July 2024
6 min read
![How to do Valuation Analysis of a Company](https://wp-asset.groww.in/wp-content/uploads/2020/02/14215225/for-blog_28Jan-01-1.jpg)
...
Once the future cash flow is discounted to present value, the investor would be able to find out the value of the [stock](https://groww.in/stocks). This helps to understand if the company is overvalued or undervalued, or at par. This is one of the key methods used in financial analysis.
  * ### **Asset Approach**
...
In order to calculate the [Net Asset Value](https://groww.in/p/nav) or NAV of the company, some intrinsic costs like Replacement Cost need to be incorporated, which complicates the issue. Also, for an indispensable person who is of utmost importance to the business, also has a replacement cost which is needed in order to calculate the Fair Value of all the “Assets” of the company. 
...
This is the [Price/Earnings Ratio](https://groww.in/p/pe-ratio), better known as PE Ratio. It is the Stock Price divided by the Earnings per Share. In fact, this is one of the most predominantly used techniques to calculate if the stock is over-valued or under.
...
This is a more traditional method of calculating valuation. Where [PBV Ratio](https://groww.in/p/price-to-book-ratio) (i.e. price to book value ratio) denotes how expensive the stock has become. Value investors prefer to use this method, and so do many market analysts.
...
[EBITDA](https://groww.in/p/EBITDA) will always be < 1 as interest, tax, depreciation and amortisation would be considered from the earnings.
...
---  
1. |  [Most Important Things to Consider Before Starting a Business](https://groww.in/blog/things-to-consider-before-opening-a-startup)  
2. |  [How to do Business and Industry Analysis of a Company?](https://groww.in/blog/how-to-do-business-and-industry-analysis)  
3. |  [How to Read the Profit and Loss Statement of a Company?](https://groww.in/blog/how-to-read-profit-and-loss-statement-of-company)  
4. |  [Why Does a Company Decide to Go Public?](https://groww.in/blog/why-does-a-company-decide-to-go-public)  
5. | [What is the Impact of Corporate Actions on Stock Price?](https://groww.in/blog/how-corporate-actions-impact-stock-price)  
