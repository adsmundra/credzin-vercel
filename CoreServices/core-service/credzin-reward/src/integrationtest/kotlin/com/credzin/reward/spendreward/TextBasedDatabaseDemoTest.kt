    ...
    fun `should demonstrate text-based JSON storage in database`() {
        ...
        val standardRecords =
            jdbcTemplate.queryForList(
                "SELECT id, transaction_id, reward_type, reward_value, created_at FROM reward.standard_spend_based_reward",
            )
        ...
        val rewardValueRecords =
            jdbcTemplate.queryForList(
                "SELECT id, transaction_channel_spend_based_reward_id, reward_value, created_at FROM reward.transaction_channel_spend_based_reward_value",
            )
        ...
        val tables =
            listOf(
                "reward.standard_spend_based_reward",
                "reward.transaction_channel_spend_based_reward_value",
            )
        ...
        tables.forEach { tableName ->
            ...
            val columns =
                jdbcTemplate.queryForList(
                    "SELECT COLUMN_NAME, DATA_TYPE, IS_NULLABLE FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'REWARD' AND TABLE_NAME = ? ORDER BY ORDINAL_POSITION",
                    tableName.uppercase(),
                )
        ...
        val jsonData =
            jdbcTemplate.queryForList(
                "SELECT reward_value FROM reward.standard_spend_based_reward UNION ALL SELECT reward_value FROM reward.transaction_channel_spend_based_reward_value",
            )
