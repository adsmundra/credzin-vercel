...
Ctrl+K
Login/Sign up
# Mutual Fund Investments at Groww Can Also Be Held in Your Demat Account
06 June 2025
2 min read
![Mutual Fund Investments at Groww Can Also Be Held in Your Demat Account](https://cms-resources.groww.in/uploads/Mutual_Funds_210a32ddfe.jpg)
...
If you wish to opt out of demat for mutual funds, you can do so easily [here](https://groww.in/help/mutual-funds/mf-dashboard/how-to-opt-out-of-demat-based-mutual-fund-investments--17).
...
## **Benefits of Holding Mutual Funds in Demat**
  1. **Seamless Bank Updates** : Easily update bank details, and redemptions go directly to your demat-linked account.
  2. **Easy Nominee Management** : Assign multiple nominees to all your mutual funds in a ratio of your choice with just one click.
  3. **Pledging Option** : Use mutual fund units held in demat form as collateral for trading.
  4. **Simplified Management** : Consolidate all your investments—mutual funds, stocks, ETFs, and more—into a single demat account.
...
We will slowly start rolling out Demat for new accounts. In case you want to opt for AMC folio, you can do it [here](https://groww.in/help/mutual-funds/mf-dashboard/how-to-opt-out-of-demat-based-mutual-fund-investments--17) anytime. For our existing users, we will start rolling this later and will keep you informed. For early access, please reach out to our customer support at support@groww.in.
Here are answers to some common questions you might have.
## FAQs
### As an existing Groww user, will I have to mandatorily move to demat?
No, moving to demat is not mandatory. 
### As a new user on Groww, will my mutual fund investments be held in demat?
Yes. However, you can use this[ link](https://groww.in/help/mutual-funds/mf-dashboard/how-to-opt-out-of-demat-based-mutual-fund-investments--17) to opt-out.
### As an existing user, when will I get access to demat for MFs?
You will be informed over an email. For early access, please reach out to our customer support at support@groww.in.
### If I move to demat, will my existing investments automatically move to demat?
No. It will be optional and only be done after your explicit consent via an OTP. We will begin to provide this service later and shall communicate about the same over email.
### Will I incur extra charges for moving my MFs to demat?
No, you will not be levied any charges like account creation and maintenance, DP charges for redemption or transferring holdings from AMC folio to your demat account.
### How are my mutual fund units held?
There are two ways to hold mutual fund units:
  1. **Demat Account**
  2. **AMC Folio** (SoA or Statement of Account - with AMCs)


### What is physical folio-based holding?
Your investments are held directly by the fund house in your name under a “AMC folio.”
### What is demat-based holding?
Your investments are held electronically in your demat account.
### How are my mutual fund investments stored currently when I invest using Groww?
Currently, all your mutual fund investments on Groww are stored in AMC folios (SoA format).
### Will I be able to view my holdings on MF Central if I invest through Groww in demat format?
Yes, absolutely.
### Will I be able to redeem mutual funds on MF Central or other platforms if I invest through Groww in demat format?
...
### Will I still be able to track external holdings on Groww?
Yes, absolutely.
### Will I still be able to track Groww holdings (including demat) externally?
Yes, absolutely.
### Will my mutual fund investments be eligible for pledge margin on Groww?
Yes, they will be eligible for pledge margin when held in demat format. However, this is not possible with mutual fund investments in electronic folios with AMC.
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Demat](https://groww.in/blog/category/demat)>Mutual Fund Investments at Groww Can Also Be Held in Your Demat Account
