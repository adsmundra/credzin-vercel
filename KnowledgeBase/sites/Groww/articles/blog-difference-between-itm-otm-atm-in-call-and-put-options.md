...
20 January 2025
4 min read
![Difference Between ITM, OTM, ATM in Call and Put Options](https://cms-resources.groww.in/uploads/Difference_Between_ITM_OTM_ATM_in_Call_and_Put_Options_95e9e155f7.png)
...
## **Call Options**
When you buy a call option, you are granted an opportunity to purchase [stocks](https://groww.in/stocks) or shares at the strike price if it is beneficial.
...
When the strike price of a call option is higher than the spot price of an underlying asset, it is an out-of-the-money [call option](https://groww.in/p/call-option).
...
Also Read: **[What is Futures and Options?](https://groww.in/p/what-is-futures-and-options)****|[Best Indicators for Option Trading | ](https://groww.in/blog/best-indicators-for-option-trading)**[**Options Trading for Beginners**](https://groww.in/blog/options-trading-for-beginners)
## **Put Options**
When you are dealing with put options, you are betting that the stock's price will drop. [Put options](https://groww.in/p/what-is-put-option) give you the right, but not an obligation, to sell a specific amount of an underlying asset at a set price within a particular time frame.
...
**Parameters** |  **ITM** |  **ATM** |  **OTM**  
---|---|---|---  
**Strike Price vs Market Price** |  Beneficial (Call: Market > Strike, Put: Market < Strike) |  Usually Equal |  Not beneficial (Call: Market < Strike, Put: Market > Strike)  
**Intrinsic Value** |  Present (determined by the price correlation) |  Exists to a minimal extent |  Absent  
**Profit Potential** |  Options immediately hold value because they already possess intrinsic value. |  Balances immediate profits with potential gains. |  Significant price shifts are necessary for profitability.  
**Suitability** |  It offers flexibility and the potential for immediate profit. |  It balances the risk with the potential for profitability. |  Employed for strategies with high risk and high rewards.  
**Level of Risk** |  Low risk |  High Risk |  Moderate Risk  
**Pricing Considerations** |  Affected by intrinsic value, expiration duration and market volatility. |  Affected by both intrinsic and extrinsic values. |  Primarily affected by the passage of time and volatility  
## **The Bottom Line**
...
---  
1. | [Best Option Trading Strategies](https://groww.in/blog/best-option-trading-strategies)  
2. | [How Future and Options can be used for Hedging?](https://groww.in/blog/hedging-in-future-and-options)  
3. | [How to Trade in Futures and Options](https://groww.in/blog/how-to-trade-in-futures-and-options)  
4. | [New Feature Alert - Safe Exit on Groww](https://groww.in/blog/safe-exit-on-groww)  
5. | [How to Trade Above Freeze Quantity in Options on Groww](https://groww.in/blog/how-to-place-orders-above-freeze-quantity-in-options)  
### Disclaimer
