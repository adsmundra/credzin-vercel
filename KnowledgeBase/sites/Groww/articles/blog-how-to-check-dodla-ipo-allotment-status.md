...
Ctrl+K
Login/Sign up
# How to Check Dodla IPO Allotment Status
06 June 2025
3 min read
![How to Check Dodla IPO Allotment Status](https://wp-asset.groww.in/wp-content/uploads/2021/06/17151850/How-to-check-Dodla-Dairy-IPO-allotment-status_Jun16.png)
...
The Dodla Dairy Ltd. IPO is open for subscription between June 16 and 18, 2021. The price band has been kept between Rs 815-825 per share with a minimum lot size of 18 shares.
**_The Dodla IPO allotment status will be finalised around June 23._**
...
**Step 2** : Click on IPOs. On the next page click on the ‘Status’ tab next to the Dodla IPO (or any other IPO you had applied for). The status tab will not be visible if you have not applied for the [IPO](https://groww.in/ipo).
[![](https://wp-asset.groww.in/wp-content/uploads/2021/06/17151227/all.png)](https://wp-asset.groww.in/wp-content/uploads/2021/06/17151227/all.png)
...
The status will show as ‘Requested’ till the time the UPI mandate reaches you and is accepted by you.
[![](https://wp-asset.groww.in/wp-content/uploads/2021/06/17151447/dodla-real.png)](https://wp-asset.groww.in/wp-content/uploads/2021/06/17151447/dodla-real.png)
...
Step 2: You will then have to select the ‘Equity’ option and then from the dropdown, select issue name – ‘Dodla Dairy Ltd.’.
...
## **FAQs on Dodla IPO Allotment**
**How do I know if I have received the Dodla IPO Allotment or not?**
...
**How are the Dodla shares being allotted?**
If Dodla IPO is oversubscribed, the shares will be distributed proportionately among investors so that each investor gets a minimum of one lot. This is done on a lottery basis, so there cannot be a guarantee that you will get the shares. It is possible that few investors do not get any shares at all, in case of over-subscription.
**Will my money come back if I don’t get Dodla IPO allotment?**
If you don’t get the allotment in Dodla IPO, the amount will be unblocked, and you will be able to use the amount in your bank account. 
**When will Dodla IPO get listed?**
Dodla IPO shares will get listed on BSE and NSE on June 28, 2021. (tentative)
Happy Investing!
### Disclaimer
