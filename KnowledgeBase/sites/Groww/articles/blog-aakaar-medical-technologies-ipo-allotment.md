...
Ctrl+K
Login/Sign up
# Aakaar Medical Technologies IPO Allotment Status: Check Latest GMP, Steps To Verify Status
25 June 2025
2 min read
![Aakaar Medical Technologies IPO Allotment Status: Check Latest GMP, Steps To Verify Status](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_06_25_T103724_442_11zon_45f342432c.jpg)
...
## **Check Aakaar Medical Technologies IPO Allotment Status Online On NSE**
  ...
  * In Select Symbol, select **_“AAKAAR.”_**
  * Enter your PAN No. and application No. 
  * Click “Submit.”


## **Check Aakaar Medical Technologies IPO Allotment Status on Bigshare Services Pvt Ltd (Registrar to the issue)**
  ...
  * In Company Selection, select **_“Aakaar Medical Technologies Limited”_**
  * Enter any of the following details 
  * Application Number, 
  * Beneficiary ID or PAN. 
  * Enter the Captcha and Click **_“Search.”_**
...
---|---  
Qualified Institutional Investors (QIBs) |  3.51  
Non-Institutional Investors |  1.48  
Retail Individual Investors(RIIs) |  1.93  
Total  |  2.28  
_Click here to check out newly_ _[Listed IPOs](https://groww.in/ipo/closed)_
## **Aakaar Medical Technologies IPO GMP Details**
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[News](https://groww.in/blog/category/news)>Aakaar Medical Technologies IPO Allotment Status: Check Latest GMP, Steps To Verify Status
