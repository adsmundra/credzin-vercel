...
07 March 2024
4 min read
![How to Cancel Mutual Fund SIP](https://wp-asset.groww.in/wp-content/uploads/2019/08/28135305/How-to-cancel-a-mutual-fund-SIP_Sept9.png)
...
Mutual Fund SIP (systematic investment plan) is one of the most common strategies adopted by many investors to increase his or her wealth. Mutual Fund SIP is an investment option in which you can deposit money in any mutual fund scheme of your choice regularly.
After a specified period or depending on your need, you can exit the fund along with the returns. Unlike lump-sum investment, you do not need to spend a large investment budget across mutual fund schemes as your investment will grow over time with SIP.
...
Pausing your SIP is possible if the mutual fund company allows such a feature on its fund. Different companies have different procedures for it. 
You can also pause your SIPs on broker platforms if they allow you to do so. Most mutual fund houses have rules wherein you can pause your SIP for a maximum of 3 to 6 months.
## **How to Cancel SIP Offline?**
You may cancel your mutual fund SIPs offline by notifying your bank and the respective AMCs. You can also have your mutual fund agent do it for you.
To understand how to stop SIP offline, follow the procedure mentioned here-
  1. Request a SIP cancellation form from your asset management firm or through online Mutual Fund Registrar and Transfer websites such as CAMS and KFin Technologies Limited.
...
You can cancel your SIP either with your MF house or directly with the KRA, such as CAMs, KFin Technologies Limited, etc.
  * ### **How to Cancel on KRAs?**


There are five different KRAs in India such as CAMS KRA, KFin Technologies Limited KRA, NSDL KRA, NSE KRA, and CVL KRA. The process for SIP cancellation would be similar in all. So, let us understand one of them for your convenience.
For CAMS KRA, you need to initiate a SIP cancellation through their website:
  1. Log in to [https://mycams.camsonline.com/](https://mycams.camsonline.com/) with your user ID and password
  2. In the top menu bar, select the ‘My Transactions’ icon
  3. In the text menu bar, choose ‘Systematic Transactions’ and then select the “active” ones
  4. The continuing systematic transactions will be visible to you. Each SIP row will have a Cancel link.
  5. Click the Cancel button and verify the cancellation.
...
The following is the step-by-step guide to get KFin Technologies Limited’s Cancellation Form. 
Visit <https://mfs.kfintech.com/investor/>.
On this page, users need to scroll to the **Investor Statement and Reports** section. From there, you can find the **SIP Cancellation** tile. Clicking on it will open a new window. In the **Services** section, choose the **SIP/STP/SWP cancellation request** from the menu.
You can download the form [here](https://mfs.kfintech.com/mfs/InvestorServices/Request%20For%20Cancellation%20Of%20%20SIP-STP-SWP.pdf).
  * ### **How to Cancel on AMCs?**


To begin, visit the website of the asset management company for which the SIP is still active. You will need the folio number, bank account number connected with the folio, and [PAN](https://groww.in/p/pan-card) as login credentials for the website. You can also cancel it through mobile applications of the respective AMCs.
Next, you need to choose the ongoing [SIP](https://groww.in/p/sip-systematic-investment-plan) that you wish to terminate and click ‘Cancel SIP.’ As is customary, the cancellation procedure will take approximately 21 days. 
## **Key Takeaways**
...
---  
1. | [What is the Difference Between SIP and Mutual Fund](https://groww.in/blog/what-is-the-difference-between-sip-and-mutual-fund)  
2. | [How to Choose Mutual Funds in India](https://groww.in/blog/how-to-choose-mutual-funds-in-india)  
3. | [How Many Mutual Funds Should I Own](https://groww.in/blog/how-many-mutual-funds-invest)  
4. | [How To Start A STP And SWP](https://groww.in/blog/how-to-start-a-stp-and-swp-on-grow)  
5. | [10 Tips to Invest in Mutual Funds](https://groww.in/blog/tips-invest-in-mutual-funds)  
