...
22 December 2023
6 min read
![How to Check the Financial Health of a Bank Using Ratios](https://wp-asset.groww.in/wp-content/uploads/2021/04/19144105/How-to-check-the-financial-health-of-a-bank-using-ratios_Apr19-01.png)
...
**_“An asset, including a leased asset, becomes non-performing when it ceases to generate income for the bank. A ‘non-performing asset’ (NPA) was defined as a credit facility in respect of which the interest and/ or installment of principal has remained ‘past due’ for a specified period of time.”_**
**_DBOD No. BP.BC/ 20 /21.04.048 /2001-2002 (RBI)_**
### **2. Understanding NPA Provisioning**
When a bank issues loans, it knows that some borrowers might default and not be able to repay the amount. To ensure that such defaults don’t derail the bank’s finances, it sets aside an amount every year for [non-performing assets](https://groww.in/p/non-performing-assets) or NPAs. This amount is called ‘provisions’. Banks usually set aside provisions from their net profit.
Every bank has different NPA provisioning since it depends on a lot of factors.
### **3. GNPA – Gross Non-Performing Assets**
Gross NPA is the total value of non-performing assets of the bank. This is an absolute number and can tell you the amount of [loans](https://groww.in/loans) that the bank is not earning money on. 
...
**Example:**_If a bank has issued a total of Rs.100 crore as loans and has a GNPA of Rs.5 crore, then the GNPA percentage will be 5%. In other words, five per cent of the loans issued by the bank are currently non-recoverable._
...
_**Example:** Like GNPA, NNPA can also be expressed as a percentage. If a bank has issued a total of Rs.100 crore as loans, a GNPA of Rs.5 crore, and NPA Provisioning of Rs.2 crore, then the NNPA will be Rs.3 crore, and the NNPA percentage will be 3%. _
...
A bank offers current accounts and [savings accounts](https://groww.in/savings-account) to people. These are low-cost deposits since the bank pays a low-interest rate on them and utilizes the funds to offer loans to borrowers. The Current Account Savings Account or CASA Ratio is the ratio of the deposits across current and savings accounts to the total deposits of the bank. 
...
Before we look at the [P/B Ratio](https://groww.in/p/price-to-book-ratio), let’s understand some basics. 
...
This is an excellent way of understanding the relationship between the market’s perception of the bank’s stocks and its [book value](https://groww.in/p/booking-value). 
## **Key Takeaways**
...
---  
1. |  [The Evolution of Banking in India](https://groww.in/blog/the-evolution-of-banking-in-india)  
2. |  [How Do Banks Make Money?](https://groww.in/blog/how-do-banks-make-money)  
3. |  [Neo Banks in India, Function & Benefits](https://groww.in/blog/neo-banking-in-india)  
4. |  [What is an Investment Bank and How Does it Work?](https://groww.in/blog/how-does-investment-bank-work)  
5. | [10 Digital Banking Features You Need to Know About](https://groww.in/blog/10-digital-banking-features-need-know)  
