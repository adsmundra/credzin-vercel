...
06 June 2025
4 min read
![Intermediaries Involved in an IPO](https://wp-asset.groww.in/wp-content/uploads/2020/07/17163201/intermediaries-involved-ipo.jpg)
...
**1. Pre-Issue** – This includes compliance with the mandatory requirements of [SEBI](https://groww.in/p/sebi-securities-and-exchange-board-of-india) and other regulatory authorities. Completion of formalities for listing the shares on the stock exchange. The merchant banker is also responsible for the appointment of various agencies involved in the issue process.
...
The Registrars are responsible for finalizing the basis of the allotment in the [IPO](https://groww.in/p/initial-public-offering). They create a final list of applications that are valid and eligible and delete the invalid ones. 
...
4. The lead manager then:-
  * Submits the Offer Prospectus to the stock exchanges and Registrar of Issue to get it approved.
  * Decide the issue date and price band with the help of the issuing company.
  * Enters the date and price band into the prospectus. This is now called the Red Herring Prospectus.
  * Prints the Red Herring Prospectus and IPO Application Forms and sends them to syndicate members for onward distribution to investors.
...
7. Once the public issue closes, the lead manager evaluates the final issue price based on the bids received. The lead manager also updates the final price in the Red Herring Prospectus and sends it to SEBI and [stock exchanges](https://groww.in/p/stock-exchange).
8. The registrar of issue:-
  * Receives the applications and funds from the syndicate members
  * Checks the completeness and authenticity of the application forms
  * Finalizes the share allotment pattern based on the valid bids
  * Prepares the Basis of Allotment
  * Transfers the shares to the Demat accounts of investors and ensures that all rejected applicants receive their refunds.
