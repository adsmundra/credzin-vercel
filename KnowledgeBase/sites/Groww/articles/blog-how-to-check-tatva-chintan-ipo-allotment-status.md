...
Ctrl+K
Login/Sign up
# How to Check Tatva Chintan IPO Allotment Status
28 July 2021
3 min read
![How to Check Tatva Chintan IPO Allotment Status](https://wp-asset.groww.in/wp-content/uploads/2021/07/23184353/How-to-check-Tatva-Chintan-allotment-status_Jul23.png)
...
The Tatva Chintan IPO was open for subscription between July 16 and July 20, 2021. The price was been kept between Rs 1073-1083 per share with a minimum lot size of 13 shares.
**_The Tatva Chintan allotment status will be finalised around July 26, 2021_** **_(tentative)._**
...
**Step 2** : Click on IPOs. On the next page click on the ‘Status’ tab next to the [Tatva Chintan IPO](https://groww.in/ipo/tatva-chintan-pharma-ipo) (or any other IPO you had applied for). The status tab will not be visible if you have not applied for the IPO.
![](https://wp-asset.groww.in/wp-content/uploads/2021/07/23182002/Image-from-iOS.png)
...
![](https://wp-asset.groww.in/wp-content/uploads/2021/07/23182100/Image-from-iOS-1.png)
...
The registrar for this IPO is Link Intime India Private Limited.
  ...
  * From the drop-down menu, select ‘Tatva Chintan’. 
...
Step 2: You will then have to select the ‘Equity’ option and then from the dropdown, select issue name – ‘Tatva Chintan’
...
## **FAQs on Tatva Chintan IPO Allotment**
**How do I know if I have received the Tatva Chintan IPO Allotment or not?**
...
**How are the Tatva Chintan shares being allotted?**
Since Tatva Chintan IPO was oversubscribed, the shares will be distributed proportionately among investors so that each investor gets a minimum of one lot. This is done on a lottery basis, so there cannot be a guarantee that you will get the shares. It is possible that few investors do not get any shares at all, in case of oversubscription.
**Will my money come back if I don’t get the Tatva Chintan IPO allotment?**
If you don’t get the allotment in Tatva Chintan IPO, the amount will be unblocked, and you will be able to use the amount in your bank account. 
**When will the Tatva Chintan IPO get listed?**
Tatva Chintan IPO shares will get listed on BSE and NSE on July 29, 2021. (tentative)
Happy Investing!
### Disclaimer
