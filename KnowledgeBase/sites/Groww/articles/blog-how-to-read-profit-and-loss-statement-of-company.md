...
Ctrl+K
Login/Sign up
# How to Read and Analyze the Profit and Loss Statement of a Company?
27 December 2023
7 min read
![How to Read and Analyze the Profit and Loss Statement of a Company?](https://wp-asset.groww.in/wp-content/uploads/2020/04/20120842/Blog_Financial-Statements.png)
...
Successful investing is about finding stocks of companies with strong fundamentals. In the simplest terms, the fundamentals of a company are the information about its financials and management, both quantitative and qualitative.
This includes reading and analyzing some important financial reports and ratios. Today, let’s talk about the Profit and Loss statement of a company and how you can read and analyze it to assess its fundamental strength. The Profit & Loss statement is also known as an Earnings Statement.
This blog will help you understand **how to analyze the Profit & Loss Statement** of a company and **how to find profit and loss,** so read on to know more about the same!
## **Profit & Loss Statement (P&L Report)/Income Statement of a Company**
An **Income Statement** can tell you how the company has performed over a given period. Every company has expenses, sales (of products and/or services), and resulting profits.
...
Let’s look at each of them in detail to understand **how to read profit and loss statement** efficiently-
  1. ### **Revenue**


Revenue is the total amount of sales made by a company during a given period.
So, if you are looking at the income statement of the past year, then the revenue subheading will tell you about the number of sales that the company has made over the period. Please remember that this is not profit but the total amount of sales.
  1. ### **Expenses**


Expenses or the cost of goods sold is an important factor when assessing the company’s financial statements.
If a t-shirt manufacturing company has a revenue of Rs.5 lakh, then what was the cost of manufacturing, transporting, and selling those goods? Also, what was the cost of human resources (employees), rent and other expenses?
The idea is to understand how much the company spent to achieve the revenue amount as per point 1. All the expenses must be considered under the ‘Expenses’ section.
  1. ### **Operating Profit**


If you deduct expenses from revenue, you get the [operating profit](https://groww.in/p/operating-profit) of the company. So, if the company earned Rs.5 lakh in revenue and incurred an expense of Rs.2.5 lakh, then its operating profit is Rs.2.5 lakh.
...
A company can have many other expenses. Hence, remembering this part is important.
  1. ### **Operating Profit Margin or Operating Margin Ratio**


The [Operating Profit Margin](https://groww.in/p/operating-margin) tells you how well the company has been using its resources to generate profits. So, if a company’s revenue is Rs.5 lakh, expenses are Rs.2.5 lakh, and Operating Profit is Rs.2.5 lakh, then:
...
This expense is deducted from the operating profit of the company. Therefore, in the example cited above, where the company has a revenue of Rs.5 lakh, an expense of Rs.2.5 lakh, and an operating profit of Rs.2.5 lakh, the interest expense of Rs.50,000 is deducted from its operating profit bringing it down to Rs.2 lakh.
If the company does not have any debts, then this section will be zero. While assessing a company’s [**Income Statement**](https://groww.in/p/income-statement), it is also important to see if the company’s debt is constantly increasing, as this can impact its profits. The higher the debt – the higher the interest expense.
  1. ### **Depreciation**


Every profit and loss statement has a section called [depreciation](https://groww.in/p/tax/depreciation-under-income-tax-act). Technically, depreciation is a non-cash expense.
As the name suggests, depreciation means the reduction in the value of an asset over time. Companies have assets. Hence, the reduction in the value of the assets over time must be factored in as a notional loss.
...
That is, 5 lakh – 2.5 lakh – 50,000 – 10,000 = 1.9 lakh
### 7. **Other Income**
...
The last segment that you need to factor in is tax. Every company needs to pay [tax](https://groww.in/p/tax) on its earnings. Let’s say, for the sake of the example, that the company has to pay tax at the rate of 30%. Therefore, its [tax liability](https://groww.in/p/tax-liabilities) is
Tax liability = (210000 x 30)100 = Rs.63,000
Hence, the net profit is
Net Profit = 210000-63000 = Rs.1.47 lakh
## **Summing Up**
As you can see, it is important to make **analysis of profit and loss statement** from top to bottom. This will give you a clear picture of how the company has performed at every step.
...
Further, companies from different industries and sectors can have different headings and subheadings. For example, a bank does not sell goods. Hence, its expenses are not the cost of goods sold but the cost of financing. Understand the core concept of an income statement, **P &L analysis** and investigate every aspect carefully.
Happy Investing!
**You May Also Be Interested to Know**  
---  
1. |  [How to Read and Understand Quarterly Reports](https://groww.in/blog/how-to-read-and-understand-quarterly-reports)  
2. |  [How to do Valuation Analysis of a Company](https://groww.in/blog/how-to-do-valuation-analysis-of-a-company)  
3. |  [How to Analyse a Company's Debt Management Ability](https://groww.in/blog/how-to-analyse-companys-debt-management-ability)  
4. |  [How to Assess a Company's Growth Potential?](https://groww.in/blog/how-to-assess-a-companys-growth-potential)  
5. | [How To Do A SWOT Analysis For Stocks Before Investing](https://groww.in/blog/how-to-do-a-swot-analysis)  
