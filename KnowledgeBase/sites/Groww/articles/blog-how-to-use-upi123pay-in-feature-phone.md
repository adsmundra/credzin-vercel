...
Ctrl+K
Login/Sign up
# RBI Launches UPI123Pay: Read How to use UPI in Feature Phone?
19 July 2023
3 min read
![RBI Launches UPI123Pay: Read How to use UPI in Feature Phone?](https://wp-asset.groww.in/wp-content/uploads/2020/06/15161454/for-blog_transfer-shares-01.jpg)
...
So to provide access to the feature phone users, RBI recently launched UPI123Pay. Now, little over 40 crore feature phone users can access [UPI](https://groww.in/blog/what-is-upi) and its related financial services. 
## **Setting Up**
Before initiating the transactions, there are a few points to consider. They are;
  1. Users need to link their bank account with UPI123.
  2. Set-up UPI PIN. This secures each of the transactions a user makes.
...
To make use of UPI123Pay through the IVR facility in feature phones, one has to follow three simple steps:
  ...
  2. Select the service such as electricity payment, phone bill or money transfer
  3. Make the payment 


## **How to Use UPI in Feature Phones?**
...
An app would be installed on the feature phone to use UPI-related financial services.
  * ### **Missed Call**


This will allow feature phone users to access their bank account and perform transactions, including money transfers and bill payments. Under this, the user needs to give a ‘missed call’ on the number displayed at the merchant outlet. The customer shall then receive an incoming call to authenticate the transaction by entering the UPI PIN.
  * ### **Interactive Voice Response (IVR)**


In this, users would be required to initiate a secured call from their feature phones to a predetermined number and complete UPI on-boarding formalities. Post this, users will be able to transact without an internet connection.
  * ### **Proximity Sound-based Payments**


This uses sound waves to enable offline, contactless, and proximity data communication on any device.
You may also want to know **[How to Transfer Money Through UPI?](https://groww.in/blog/how-to-transfer-money-through-upi)**
## **Takeaway**
