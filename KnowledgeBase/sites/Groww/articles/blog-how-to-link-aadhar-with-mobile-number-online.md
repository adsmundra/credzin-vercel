...
15 January 2025
6 min read
![How to Link Aadhaar with Mobile Number Online](https://cms-resources.groww.in/uploads/How_to_Link_Aadhar_with_Mobile_Number_Online_2519689325.jpg)
...
Here, we’ll be providing a detailed guide on **how to link Aadhaar with mobile numbers**. So, if you have not registered your phone number with UIDAI yet, read on.
## **How to Link Aadhaar Card with Mobile Number Online**
Here is the process to **link mobile number to Aadhar Card online at home** -
  1. Open the official [Indian Postal Service](https://ccc.cept.gov.in/ServiceRequest/request.aspx) portal on your browser.
  2. Fill in the required information, such as your name, mobile number, address, email id, etc.
  3. From the drop-down menu, select ‘PPB-Aadhaar Service’.
  4. Choose UIDAI-Mobile/Email to Aadhaar Linking/Update.
  5. After filling in the required fields and picking the apt selections, click on the ‘Request OTP’ option.
  6. Fill in the OTP that you would receive on your mobile number on the next screen.
  7. Press ‘Confirm Service Request’. A Reference Number will be provided, which can be used for tracking the application status.
  8. The request will be sent to the nearest post office after successful submission.
  9. Next, an officer will run a verification process. He/She will mark a visit to your residence and do verification using a mobile biometric device.
  10. The update/linking process will be completed by the officer. Note a certain fee will be applicable to avail of this service.


### **Verify Mobile Number on Aadhar Card**
Once an individual’s mobile number is successfully registered with UIDAI, he/she can verify the phone number without any hassle. The [Aadhar card](https://groww.in/p/aadhaar-card) update mobile number online can be done through the below mentioned steps-
**Step 1:** Visit the official website of UIDAI.
**Step 2:** Navigate to the ‘Aadhaar Services’ section and click on ‘Verify Email/Mobile Number’.
**Step 3:** After entering the required details, such as the Aadhaar number, mobile number/ email, etc., you’ll receive an OTP.
**Step 4:** Enter the OTP before clicking on the ‘Verify OTP’ option to complete the verification procedure.
Apart from visiting an Aadhaar Enrolment Centre, one can also complete this process of linking a mobile number with Aadhaar number at home.
▶️ You may also want to know [**How to Change your Mobile Number in Aadhaar Card?**](https://groww.in/blog/how-to-change-your-mobile-number-in-aadhaar-card/)  
---  
## **How to Link Aadhaar Card with Mobile Number Offline for the First Time?**
By following the steps mentioned below, you can easily do the aadhar card mobile number link process-
**Step 1:** Visit UIDAI’s official website or use the mAadhaar mobile app to locate the nearest Aadhaar Seva Kendra or Aadhaar Enrolment Centre. You can also dial 1947 for the same purpose.
**Step 2:** After visiting the Aadhaar Seva Kendra, collect the Aadhaar Correction Form and fill in the required information. Remember to provide the current phone number that you want to link with your Aadhaar.
**Step 3:** After placing a request with the official at the centre, submit the form and help the executive to verify your biometrics.
**Step 4:** Post successful authentication of your biometrics, you will receive the acknowledgement slip from the executive. 
**Step 5:** The slip comes with an Update Request Number (URN), which you can utilise to track the Aadhaar update status. 
Once your mobile number is linked successfully, you can avail of various Aadhaar services by entering the OTPs that you receive on your phone. Instead of using the URN, you can choose to dial 1947 – the toll-free number provided by UIDAI, to check the Aadhaar update status. 
Individuals need to pay a fee to the authorised executive at the Aadhaar Enrolment Centre for the service. 
### **How to Book an Appointment?**
**Step 1:** Once you click the ‘Book Appointment’ in step 9 given above, you need to search for an enrolment centre. There are many options to search for an enrollment centre, such as through centre name, Pincode, state, etc.
Pick any one option which is convenient for you and click on get details.
**Step 2:** The portal will show you a list of nearby enrollment centres; pick one and choose the date and time slot as per your convenience by clicking ‘Book Appointment’.
**Note:** Choose from the green ones while selecting the date, as the red ones are already booked.
**Step 3:** Crosscheck all the details once again and click on confirm.
You will get an Application form in PDF format the moment you click on confirm. You can save it and get a printout of the same before going to the enrollment centre.
## **How to Update Mobile Number Linked with Aadhaar?**
In case you already have a mobile number linked with your Aadhaar and wish to update it, you can follow these steps for mobile number add in Aadhar card:
**Step 1** : Go to the official portal of Aadhar here https://ask.uidai.gov.in/
**Step 2:** After typing in your registered phone number/email ID and entering the captcha code before clicking on ‘Get OTP’/’Send OTP’
**Step 3:** Enter the OTP that you receive on your phone and proceed to the next step
**Step 4:** From the ‘Online Aadhaar Services’ dropdown menu, select the option that you wish to change
**Step 5:** To update your registered mobile number, click on the relevant option and fill in the necessary details
**Step 6:** Once you enter the captcha code, you will receive an OTP on your registered mobile number. Click on the ‘Save and Proceed’ option post-verification of the OTP.
**Step 8:** Crosscheck all the details one last time and click on Submit.
**Step 9:** In the next step, you will see a Success Screen with your Appointment ID. Click on the ‘Book Appointment’ option to book a slot at the Aadhaar enrollment centre.
After completing the steps mentioned above, you must go to the Aadhaar Seva Kendra nearest your place. There, you need to pay a nominal fee of Rs.25 and provide additional information that might be necessary.
Thus, now you know **how to link Aadhaar with mobile number online UIDAI** , and the process to update it.
Most people prefer using UIDAI’s Service Update Portal (SSUP) to update their phone numbers, owing to its convenience. That said, you can also choose to visit an Aadhaar Enrolment Centre for the same purpose.
## **Required Documents for Aadhar Card Link With Mobile Number**
A self-attested copy of your Aadhaar card is the only document necessary to link your Aadhaar card to a mobile connection.
## **Charges to Link Mobile Number with Aadhar**
During Aadhaar enrolment, you do not need to pay any fees to link your Aadhaar card with your cell phone number.
If you want to link, alter, or update your Aadhaar-registered mobile number, you must pay Rs. 50. (inclusive of GST). It should be noted that no additional cost is necessary if many fields are modified in the same instance.
## **Benefits of the Aadhaar Verification Mobile Number Process**
Below mentioned are some of the advantages of linking Aadhaar to a cellphone number-
  * To use various Aadhaar-related services, you must link your Aadhaar card to your cell phone number.
  * To use the online Self-Service Update Portal (SSUP) for updates, your cell number must be linked to your Aadhaar card.
  * To utilize all Aadhaar-related online services, you must also link your cellphone number to your Aadhaar card.
  * You can carry your Aadhaar card on your phone and use it to access numerous Aadhaar services using the mAadhaar app.
  * To get your Aadhaar card online, commonly known as e-Aadhaar, you must input the OTP issued to your registered mobile number.
  * OTPs are given to your registered mobile number and must be typed to utilize Aadhaar services. These OTPs provide an additional layer of protection to your Aadhaar.
  * If your phone number is not connected to your Aadhaar, you cannot use these services.

**You may also want to know**  
---  
1. |  [How to Apply for New Aadhar Card Online](https://groww.in/blog/how-to-apply-for-new-aadhar-card-online)  
2. |  [How to Link Your Aadhaar with PAN to File Income Tax Returns](https://groww.in/blog/how-to-link-aadhaar-with-pan-to-file-income-tax-returns)  
3. |  [How to Update Aadhaar Card Address](https://groww.in/blog/how-to-update-aadhaar-card-address)  
4. |  [How to Change your Mobile Number in Aadhaar Card](https://groww.in/blog/how-to-change-your-mobile-number-in-aadhaar-card)  
5. |  [5 Ways to Download Your Aadhar Card Online](https://groww.in/blog/5-ways-to-download-your-aadhar-card-online)  
