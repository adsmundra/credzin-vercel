...
07 April 2025
3 min read
![What is CDSL Easi and How to Register For It?](https://cms-resources.groww.in/uploads/Blog_Cover_Image_27_1886b78242.jpg)
...
Central Depository Services Ltd (CDSL) is a prominent depository in India. In addition to performing depository functions, it offers an online portal called CDSL Easi. CDSL Easi is a convenient service that helps investors access data about their holdings and transactions. Here, we will learn more about the platform and how to register on it.
## **What is CDSL?**
Before we explore the Easi platform, let’s first look at CDSL and its role.
Investors open demat accounts with a depository such as CDSL.
NSDL is India’s largest depository. A depository is a centralised location where securities are stored in a dematerialised format. [CDSL](https://groww.in/blog/cdsl-demat-account) also facilitates the transfer of shares from one demat account to another. Storing securities in an electronic format eliminates the need for physical certificates.
The depository extends its services to investors through depository participants. It also tracks electronic transactions and the holdings in a demat account.
## **CDSL Easi: Explained**
CDSL Easi stands for electronic access to securities information. CDSL Easi is a platform offered by CDSL that allows clients to easily view, monitor, and download data regarding their holdings and transactions. The platform compiles and provides a comprehensive view of the investments and data related to transactions that have taken place in the demat account. A user can also view data of multiple demat accounts on the platform.
The primary objective of CDSL Easi is to provide users with a streamlined, secure, and efficient way to access data. CDSL introduced this platform to support demat account holders to adapt to the changes in the settlement period of securities. Further, account holders can access data in a secure environment.
## **How to Register for CDSL Easi?**
The registration process for CDSL Easi is simple. Here are the steps needed to register for the online portal:
**Step 1:** Visit the CDSL website - web.cdslindia.com/myeasitoken/home/loginand click on Register for Easi
**Step 2:** Enter your 16-digit demat account number in the BO ID box.
**Step 3:** In the password box, enter your PAN card number, birth date, and month in DDMM format.
**Step 4:** Upon submitting the details, you will receive an OTP on your registered email and phone number.
**Step 5:** Enter a username, and password, and answer the security question.
**Step 6:** If an account holder has multiple demat accounts, they can group the demat accounts under one username by entering the respective account numbers.
**Step 7:** Click ‘Continue’ to complete the registration.
## **Advantages of CDSL Easi**
CDSL Easi offers several advantages to users. Given below are some of the key pros of CDSL Easi.
  * ### **No Cost**


CDSL Easi is an online facility that users can avail of at no cost. Upon completion of the registration process, users can access the portal.
  * ### **Security**


Along with providing users access to key data, CDSL Easi ensures a secure experience. Modern security technology is used to protect user data.
  * ### **Access to Data**


The primary function of CDSL Easi is to provide users with access to data in a streamlined and user-friendly manner. Users can view and monitor their holdings and transactions in one or multiple demat accounts via the platform.
  * ### **Monitor Corporate Announcements**


Clients including beneficial owners (BO) and clearing members (CM) can monitor corporate announcements related to the securities held in their demat accounts. Every user can add 25 more ISINs and monitor their corporate announcements.
  * ### **Aids in Financial Planning**


CDSL Easi allows users to track and monitor data about their investments, holdings, and transactions under one platform. Users can make use of this data to review or formulate financial plans.
## **Limitations of CDSL Easi**
The limitations of CDSL Easi are as follows:
  * The primary limitation is that it does not allow users to transfer shares from one demat account to another.
  * The platform limits users to only access data such as account statements, transaction history, and holdings.
  * In order to transfer securities or submit on-market or off-market instructions, users will need to upgrade their account to CDSL Easiest.
  * Users can only view data on the holdings and transactions for the previous 7 days. Data for longer periods is unavailable.


### **Conclusion**
In this age of digitalisation, for investors and market participants it is important to have access to services that can help them adapt to the rapidly evolving financial environment. CDSL Easi is one such platform that allows users to access and monitor important data such as transaction history, holdings, and account statements through a secure platform.
### Disclaimer
