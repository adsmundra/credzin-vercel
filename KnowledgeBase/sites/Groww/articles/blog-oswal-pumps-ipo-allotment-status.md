...
Ctrl+K
Login/Sign up
# Oswal Pumps IPO Allotment Status: Check Latest GMP, Steps to Verify Status
18 June 2025
2 min read
![Oswal Pumps IPO Allotment Status: Check Latest GMP, Steps to Verify Status](https://cms-resources.groww.in/uploads/TAX_SLAB_2025_06_18_T104423_047_11zon_87b94242e5.jpg)
...
The basis of allotment for Oswal Pumps IPO will be announced today, 18 June 2025. The bidding window was open from June 13, 2025, to June 17, 2025, during which the IPO received 55,80,42,696 bids against 1,62,12,980 total shares offered. 
## **Check Oswal Pumps IPO Allotment Status Online On NSE**
  ...
  * In Select Symbol, select **_“OSWALPUMPS”_**
  * Enter your PAN and Application number
  * Click “Submit”


## **Check Oswal Pumps IPO Allotment Status Online On BSE**
  * Click [**here**](https://www.bseindia.com/investors/appli_check.aspx) to visit the application status page
  * In Issue Type, **_“Equity”_**
  * In Issue Name, select **_“OSWAL PUMPS LIMITED”_**
  * Enter your **_“Application Number”_** or **_“PAN”_**
  * Click on **_“I am not a Robot”_**
  * Click “Submit”


## **Check Oswal Pumps IPO Allotment Status on MUFG Intime India Private Limited (Registrar to the issue)**
  * Click [**here**](https://linkintime.co.in/Initial_Offer/public-issues.html) to visit MUFG Intime’s application status page
  * Under, **_Please select company_** , select **_“Oswal Pumps Limited”_**
...
[Oswal Pumps IPO](https://groww.in/ipo/oswal-pumps-ipo) is a bookbuilding issue of ₹1,387.34 crores, consisting of a fresh issue of ₹890.00 crores and an OFS (offer for sale) component of ₹497.34 crores. The price band is set between ₹584 and ₹614 per share. 
## **Oswal Pumps IPO Overall Subscription Status**
[17 June, 2025, End of the day]
**_Investor Category_** |  **_Subscription (Times)_**  
---|---  
Qualified Institutional Buyers(QIBs) | 88.08  
Non-Institutional Investors | 36.70  
Retail Individual Investors(RIIs) | 3.60  
Total | 34.42  
## **Use of Proceeds**
The net proceeds from the fresh issue will be used towards the following objectives: 
  * Fund capital expenditure 
  * Invest in Oswal Solar, the wholly-owned Subsidiary, to set up a new manufacturing unit and repay/pre-pay borrowings. 
  * Repay/pre-pay the company’s outstanding borrowings 
  * General corporate purposes


## **Oswal Pumps IPO GMP Details**
As of 18 June 2025, Oswal Pumps IPO GMP stood at ₹60. The expected listing price is ₹674, i.e., a 9.77% gain per share over the upper price band. 
**_Source: Business Standard Report dated 18 June, 2025_** **_Disclaimer: The GMP (Grey Market Premium) price is an unauthenticated market related news and has no discernible basis. The same quoted above is as per news appeared in the media report and is for information purposes only. The investor shall do their own study/research before using the same for taking any decision to invest. We neither engage in, trade, or deal in the grey market nor we recommend or endorse trading in the grey market._**  
---  
