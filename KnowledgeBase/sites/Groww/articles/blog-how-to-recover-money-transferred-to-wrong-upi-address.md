...
Ctrl+K
Login/Sign up
# How to Recover Money Transferred to Wrong UPI Address
30 July 2024
3 min read
![How to Recover Money Transferred to Wrong UPI Address](https://cms-resources.groww.in/uploads/mitya_ivanov_2_H_Wk_ORIX_3_II_unsplash_11zon_a98039976e.jpg)
...
Sometimes, payments are mistakenly sent to the wrong UPI address, which causes significant concern and confusion among users dealing with the **wrong UPI transaction**.
When faced with such a situation, it is crucial to take immediate action to rectify the error and ensure the timely recovery of the transferred funds.
In this blog, you will learn how to recover the money that you sent wrongly.
## **How to Retrieve Money Sent to a Wrong Account**
Here are a few ways to recover **money sent to the wrong UPI** address:
  * ### **Take Immediate Action**


When dealing with funds mistakenly sent to the wrong UPI address, acting quickly is crucial. As soon as you notice the error, promptly take steps to rectify it. The more time that passes, the greater the risk that the recipient might transfer or withdraw the funds. 
Contact your bank or payment service provider (PSP) right away to start the recovery process.
  * ### **Contact the Recipient Directly**


Get in touch with the person to whom you sent the funds and politely request a refund. Provide them with all the required transaction details and request their cooperation in paying back the money.
  * ### **Reach Out to UPI App Customer Support**


Notify the customer support team of your UPI app about the erroneous transaction. Give detailed information and evidence of the transaction to help facilitate the refund process.
  * ### **File a Complaint with NPCI**


If resolving the issue with the app's support team proves challenging, escalate by filing a **wrong UPI transaction complaint** with the National Payments Corporation of India ([NPCI](https://groww.in/banking/national-payments-corporation-of-india-npci)).
NPCI manages UPI transactions and offers a grievance redressal system for such cases.
To report an issue, visit the NPCI's official website or contact their customer support. Supply all required details and adhere to their instructions for the next steps.
  * ### **Reach Out to the Banking Ombudsman**


If you are not satisfied with the responses from your bank or the UPI app's support team, consider escalating the issue to the Banking Ombudsman. They can act as a mediator between you and the involved parties, helping to resolve the dispute effectively.
  * ### **File a Report with the Police**


If a significant amount of money is involved and you suspect fraud, consider lodging a **wrong transaction complaint** with the police. Provide all the relevant details, including transaction information and any evidence you have. This action can help you launch a formal investigation, improving your chances of recovering your funds.
  * ### **Pursue Legal Action**


If other methods are unsuccessful and the amount involved is considerable, you might consider pursuing legal action.
Legal expert consultants help you decide on the best course of action. They can guide you through the legal process and represent your interests to help you recover the funds.
## **How To Prevent Wrong UPI Transactions**
To safeguard against **wrong UPI transactions** , it is vital to implement preventive measures. Here are some essential tips to consider:
  * **Verify UPI Details:** Always double-check the recipient's name, UPI address, and other details before initiating any transaction to ensure accuracy.
  * **Save Beneficiary Information:** You must save frequent recipients' UPI details in your app to minimise any errors when entering their information for future transactions.
  * **Confirm Details with Recipients:** When sending money to a new or unfamiliar UPI address, take a moment to confirm the details directly with the recipient beforehand. This simple step can prevent potential mistakes.
  * **Enable Transaction Confirmation:** Utilise the transaction confirmation feature available in some UPI apps, which adds an extra layer of security by requiring your approval before completing the transfer.


## **The Bottomline**
Recovering money sent to the wrong UPI address requires swift action and adherence to established procedures. By following these steps and staying persistent, you can effectively reverse a **wrong UPI transaction** within the critical 24 to 48 hours, as mentioned by the Reserve Bank of India (RBI).
Remember to keep detailed records of all communications and transactions for reference.
...
4. | [How to Transfer Money Through UPI?](https://groww.in/blog/how-to-transfer-money-through-upi)  
5. | [How do Banks Calculate Interest on Savings accounts & FD in India?](https://groww.in/blog/how-banks-calculate-interest-on-savings-accounts-and-fd)  
...
Related Posts
[Difference Between IMPS and UPI Fund Transfer](https://groww.in/blog/imps-vs-upi)[Difference Between RuPay and Visa Card](https://groww.in/blog/difference-between-rupay-and-visa-card)[Overdraft vs Personal Loan: Which is Better?](https://groww.in/blog/overdraft-vs-personal-loan)[How to Register a UPI Complaint](https://groww.in/blog/how-to-register-upi-complaint)[What is VPA in UPI: Everything You Must Know](https://groww.in/blog/what-is-vpa-in-upi)[How to Manage Multiple Credit Cards](https://groww.in/blog/how-to-manage-multiple-credit-cards)[What is a Virtual Credit Card](https://groww.in/blog/what-is-virtual-credit-card)
All Topics
[
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Banking](https://groww.in/blog/category/banking)>How to Recover Money Transferred to Wrong UPI Address
