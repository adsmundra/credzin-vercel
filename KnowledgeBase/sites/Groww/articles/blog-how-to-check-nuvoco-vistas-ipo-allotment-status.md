...
Ctrl+K
Login/Sign up
# How to Check Nuvoco Vistas IPO Allotment Status
18 August 2021
3 min read
![How to Check Nuvoco Vistas IPO Allotment Status](https://wp-asset.groww.in/wp-content/uploads/2021/08/11145825/Aug11-06.png)
...
The Nuvoco Vistas IPO is open for subscription between August 9 and August 11,2021. The price band has been kept between Rs 560-570 per share with a minimum lot size of 26 shares.
**_The Nuvoco Vistas IPO allotment status will be finalised around August 17 (tentative)._**
...
**Step 2** : Click on IPOs. On the next page click on the ‘Status’ tab next to the [Nuvoco Vistas ](https://groww.in/ipo/nuvoco-vistas-ipo)[IPO](https://groww.in/ipo/nuvoco-vistas-ipo) (or any other IPO you had applied for). The status tab will not be visible if you have not applied for the IPO.
[![](https://wp-asset.groww.in/wp-content/uploads/2021/08/09160314/Image-from-iOS-13.png)](https://wp-asset.groww.in/wp-content/uploads/2021/08/09160314/Image-from-iOS-13.png)
**Step 3** : If you have received the allotment in the IPO, ‘Allotted’ will be written next to your application number. Or else, the status will show as ‘Rejected’. It will show as ‘Approved’ till the allotment is finalized. The status will not show up and ask you to ‘Refresh’ if you have not accepted the mandate.
[![](https://wp-asset.groww.in/wp-content/uploads/2021/08/09161539/Image-from-iOS-15.png)](https://wp-asset.groww.in/wp-content/uploads/2021/08/09161539/Image-from-iOS-15.png)
...
The registrar for this IPO is Link Intime India Private Limited.
  ...
  * After you land on the website’s homepage, click on [public issues](https://linkintime.co.in/IPO/public-issues.html). You will see a drop-down that says ‘Select Company’.


  * From the drop-down menu, select ‘Nuvoco Vistas’. 
...
Step 1: Investors are required to follow this link to check their IPO allotment status on BSE: [https://www.bseindia.com/investors/appli_check.aspx](https://www.bseindia.com/investors/appli_check.aspx).
Step 2: You will then have to select the ‘Equity’ option and then from the dropdown, select issue name – ‘Nuvoco Vistas’
...
## **FAQs on Nuvoco Vistas IPO Allotment**
**How do I know if I have received the Nuvoco Vistas IPO Allotment or not?**
...
**How are the Nuvoco Vistas shares being allotted?**
If Nuvoco Vistas IPO is oversubscribed, the shares will be distributed proportionately among investors so that each investor gets a minimum of one lot. This is done on a lottery basis, so there cannot be a guarantee that you will get the shares. It is possible that few investors do not get any shares at all, in case of oversubscription.
**Will my money come back if I don’t get Nuvoco Vistas IPO allotment?**
If you don’t get the allotment in Nuvoco Vistas IPO, the amount will be unblocked, and you will be able to use the amount in your bank account. 
**When will Nuvoco Vistas IPO get listed?**
Nuvoco Vistas IPO shares will get listed on BSE and NSE on August 23, 2021. (tentative)
Happy Investing!
### Disclaimer
