...
13 March 2025
3 min read
![Differences between MCX vs NCDEX](https://cms-resources.groww.in/uploads/TAX_SLAB_34_11zon_ab9c010342.jpg)
...
**MCX (Multi Commodity Exchange of India)** and NCDEX (National Commodity and Derivatives Exchange) are **commodity exchanges** that provide a platform for commodity trading in India. Both MCX and NCDEX are SEBI-regulated and cater to different commodity market segments. 
**MCX vs NCDEX:** This blog will compare MCX with NCDEX and tell you how the two differ from each other. 
## **What Is MCX?**
MCX, or Multi [Commodity Exchange](https://groww.in/blog/commodity-exchanges-in-india), is one of the leading commodity derivative exchanges in India. MCX was established in November 2003. Over the years, it has grown to become India’s No. 1 exchange, providing traders with an efficient platform for price discovery and risk management. It is regulated by the Securities and Exchange Board of India (SEBI). 
## **What Is NCDEX?**
Incorporated on April 23, 2003, [NCDEX](https://groww.in/blog/what-is-ncdex) is another major commodity exchange in India that focuses mainly on agricultural commodities. It provides a trading platform for futures and option contracts on commodities.
## **Key Differences Between MCX and NCDEX**
**_Aspect_** |  **_MCX_** |  **_NCDEX_**  
---|---|---  
Primary Focus Area |  Metals, energy, bullion |  Agricultural commodities  
Popular Commodities |  Gold, Silver, Crude Oil, Copper, Zinc |  Wheat, Sugar, Soybean, Guar Gum, Spices  
Liquidity |  Higher liquidity due to global interest |  Lower liquidity compared to MCX  
Trading Hours |  9:00 AM to 11:30 PM |  10:00 AM to 5:00 PM  
Price Volatility |  Higher due to global economic factors |  More stable, influenced by seasonal trends  
## **Types of Commodities Traded On MCX**
[MCX](https://groww.in/p/what-is-mcx-trading) primarily offers trading in the following types of commodity derivative contracts:
  * Bullion 
  * Industrial metals 
  * Energy 
...
### **Key Features & Advantages of NCDEX**
  * **Focus on agricultural commodities:** NCDEX offers a diverse set of agricultural commodities, including wheat, rice, sugar, pulses, oilseeds, and spices. It also offers a metal product called **_Steel Long_**. 
