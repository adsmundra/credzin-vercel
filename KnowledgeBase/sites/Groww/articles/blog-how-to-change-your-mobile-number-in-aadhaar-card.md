...
01 April 2025
2 min read
![How to Change your Mobile Number in Aadhaar Card?](https://wp-asset.groww.in/wp-content/uploads/2020/05/07172900/How-to-UpdateChange-Your-Mobile-No.-in-Aadhaar-Card.jpg)
...
The procedure for updating mobile numbers with an Aadhaar card has become much simpler owing to new features on UIDAI’s online portal. Individuals can now link mobile number to Aadhaar card online via the Self-service Update Portal (SSUP) as well as offline without any hassle.
## **How to Change Mobile Number in Aadhar Card Online**
The mobile number in the Aadhar Card can’t be changed directly online as biometric authentication is required. Either you can visit the nearest [**Aadhar Enrolment centre**](https://appointments.uidai.gov.in/easearch.aspx) or book an appointment online via the official UIDAI website. 
Here’s how you can book the appointment online -
**Step 1:** Visit the [**UIDAI website**](https://uidai.gov.in/) and select your preferred language. 
**Step 2:** Click “My Aadhaar”>” Get Aadhaar”>” Book an Appointment.”
**Step 3:** Enter your city/location and click ‘Proceed to Book Appointment’.
**Step 4:** Enter your mobile number, Captcha, and click “Generate OTP.”
**Step 5:** Enter the OTP and click on “Verify OTP.”
**Step 6:** Select “Resident Type” and enter 
  * Aadhaar Number
  * Name on Aadhaar
  * Date of Birth
...
**Step 7:** Select Fields to be Updated. For instance, “New Mobile No” here. 
**Step 8:** Click “Next” and Select Appointment Date & Time. 
**Step 9:** Review the appointment details and click “Submit.”
**Step 10:** Visit the Aadhar centre at the scheduled time and wait for your turn. 
**Step 11:** The concerned person there will complete the biometric authentication and update your mobile number. 
**Step 12:** You need to pay the fee, i.e., ₹50, for the update request and get your acknowledgement slip. This contains a URN (Update Request Number), which you can further use to check the status update. 
## **How to Change Mobile Number in Aadhar Card Offline?**
To change the mobile number in your Aadhar card offline, you are required to follow the below steps. 
**Step 1:** Visit a Permanent Enrolment Centre. Click [**here**](https://appointments.uidai.gov.in/easearch.aspx) to find the centre nearest to you.
**Step 2:** Visit the centre with your Aadhar card. Fill out the form with all the latest details and complete biometric authentication to verify your identity. 
**Step 3:** A ₹50 fee is applicable for the update request. 
**Step 4:** Once the update is complete, you’ll receive an Acknowledgment receipt. This includes the Update Request Number (URN), which you can use to track the status update on the UIDAI website. 
**Step 5:** The mobile number update usually takes 10 to 15 days. Once it is updated, you’ll receive a confirmation over SMS. 
...
Related Posts
[How to Link Aadhaar Card to LPG Connection](https://groww.in/blog/how-to-link-aadhaar-card-to-lpg-connection)[How to Link Aadhaar with LIC Policy](https://groww.in/blog/how-to-link-aadhaar-with-lic-policy)[How to Link Aadhaar with Driving Licence](https://groww.in/blog/how-to-link-aadhaar-with-driving-licence)[How to Link Aadhaar Card to Voter ID](https://groww.in/blog/how-to-link-aadhaar-to-voter-id)[How to Apply for New Aadhar Card Online](https://groww.in/blog/how-to-apply-for-new-aadhar-card-online)
All Topics
[
