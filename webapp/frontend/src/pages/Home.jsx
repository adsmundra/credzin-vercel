...
// // Slick carousel settings for coverflow/deck effect with custom arrows and smooth animation
...
//             <div
//               key={i}
//               className="flex flex-col items-center gap-0 rounded-xl bg-none from-[#1b2127] to-[#2c333a] mx-2 p-2 shadow-2xl transition-all duration-300 hover:scale-105 hover:shadow-blue-500/50 w-24 sm:w-28 md:w-32"
//             >
//               {/* Card Image */}
//               <div
...
//                 <p className="text-sm font-semibold text-white leading-snug">{card.card_name}</p>
