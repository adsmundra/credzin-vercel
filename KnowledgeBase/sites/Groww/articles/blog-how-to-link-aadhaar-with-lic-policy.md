...
30 May 2023
4 min read
![How to Link Aadhaar with LIC Policy](https://cms-resources.groww.in/uploads/How_to_Link_Aadhaar_with_LIC_Policy_e43fd4db56.png)
...
The Life Insurance Corporation of India, commonly called LIC, is one of India’s biggest names in the insurance industry. From offering tons of schemes related to term insurance, pension, endowment, money back, and whole life plans, LIC has been a household name for years now.
In order to extend its reach and offerings of additional benefits nationwide, LIC now allows linking its policies with Aadhaar Cards. This has tremendously helped the organisation gather every policy detail under one roof, enabling quick access.
This move of the **LIC Aadhar link** is not only advantageous for LIC but for the policyholders, too, as it has simplified addressing policies efficiently.
In this blog, we have jotted down how you can **link LIC policy with Aadhar card** through online and offline methods. Let’s begin!
## **LIC Aadhar Link Online Process**
The process of **Aadhar link to LIC policy online** is fairly easy. Here is a step-by-step process-
**Step 1:** Open your web browser and visit LIC’s official website.
**Step 2:** Search for the option that says **‘LIC Aadhaar Link** ’ and click on the same.
**Step 3:** Click on ‘Proceed’ after reading the given instructions.
**Step 4:** A screen will be displayed wherein you would have to fill in your name, DOB, PAN details, [Aadhaar](https://groww.in/p/aadhaar-card) number, LIC policy number, etc.
**Step 5:** Submit the form after you carefully crosscheck the filled-in details.
**Step 6:** You will also get a captcha code, filling in on which you will have to click on ‘Get OTP’.
**Step 7:** An OTP will be sent to your registered mobile number, which must be submitted to complete the linking.
Once you submit your information, it will be sent to UIDAI’s CIDR (Central Identities Data Repository) for running a verification check.
The **Aadhaar LIC link** will be deemed successful after you receive a confirmation message on your registered mobile number.
### **Alternative Way**
You can even avail of the facility to update your Aadhaar details in your LIC account by signing in to your account.
Simply click on the ‘Registered User’ option and then go forward with updating your Aadhaar card details.
But if you are not a registered user, you can pursue the below-listed steps-
**Step 1:** Open the official portal of LIC.
**Step 2:** To get yourself registered, click on the ‘New User’ option.
**Step 3:** Here, you will have to create a user ID and password.
**Step 4:** Upload your scanned images of your Aadhaar and PAN card in this step.
**Step 5:** Now, you will become a registered user of LIC’s online services. You will now be able to update your Aadhar card details from your newly formed account.
## **Process to Link Aadhaar with LIC Policy Offline**
If you find the online process a bit complex, you can opt for the offline process too. Here is how to link Aadhaar with LIC Policy via an offline mode-
**Step 1:** Visit the nearest LIC office and reach out to an executive to avail of an Aadhaar linking mandate form. Note this form is available on the official portal of LIC too.
**Step 2:** Make sure to carry your [PAN](https://groww.in/p/pan-card), Aadhaar Card, Form 60 and necessary policy documents with you. You would have to self-attest their copies and submit them along with the form.
**Step 3:** Once your form and provided proofs have been verified by a LIC executive, it will be taken forward to UIDAI for further verification.
After verification, a message confirming the linking completion will be sent to your mobile number.
### **A Few Points to Note**
  * You can even link your lapsed policies to Aadhar in case of defaults in payments. You would have to simply state your policy number in the Aadhaar mandate form while you opt for the offline procedure.


  * Linking multiple LIC policies with your Aadhaar Card is also possible. You can opt for so by applying to link all the policies at once. This saves a lot of time and effort that goes into filling out multiple forms.


## **Conclusion**
Linking your Aadhaar with LIC is optional but harbours many benefits.
It authenticates your validity, helps you validate multiple LIC policies at once, and saves you the cost that may occur in case of any fraud.
To secure yourself from any faulty activities, this linking can prove to be worth the effort. So, if you plan to link your LIC policies to your Aadhar Card, you can take help from the aforementioned online and offline processes.
**You May Also Be Interested to Know-**  
---  
1. |  [How to Link Aadhaar Card to Bank Account](https://groww.in/p/aadhaar-card/link-aadhaar-card-to-bank-account)  
2. |  [How to Link Aadhar with EPF Account](https://groww.in/p/aadhaar-card/how-to-link-aadhar-with-epf-account)  
3. |  [How to Link Aadhaar Card to Voter ID](https://groww.in/blog/how-to-link-aadhaar-to-voter-id)  
4. |  [How to Link Aadhaar with Driving Licence](https://groww.in/blog/how-to-link-aadhaar-with-driving-licence)  
5. |  [How to Link Aadhaar with Mobile Number Online IVRS/OTP](https://groww.in/blog/how-to-link-aadhar-with-mobile-number-online)  
...
Related Posts
[How to Link Aadhaar Card to LPG Connection](https://groww.in/blog/how-to-link-aadhaar-card-to-lpg-connection)[How to Link Aadhaar with Driving Licence](https://groww.in/blog/how-to-link-aadhaar-with-driving-licence)[How to Link Aadhaar Card to Voter ID](https://groww.in/blog/how-to-link-aadhaar-to-voter-id)[How to Apply for New Aadhar Card Online](https://groww.in/blog/how-to-apply-for-new-aadhar-card-online)[How to Change your Mobile Number in Aadhaar Card?](https://groww.in/blog/how-to-change-your-mobile-number-in-aadhaar-card)
All Topics
[
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Aadhar](https://groww.in/blog/category/aadhar)>How to Link Aadhaar with LIC Policy
