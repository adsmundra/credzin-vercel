...
19 July 2024
5 min read
![How to Invest in Fixed Deposit\(FD\)](https://wp-asset.groww.in/wp-content/uploads/2020/11/03181257/how-to-invest-in-FD.jpg)
...
Are you among those individuals who think investing in a fixed deposit is a safer and guaranteed way to generate income?  _If yes, then you are not wrong!_
...
_On that note, read on to find more!_
...
In case you plan on parking your money into an FD scheme for a significant period, consider investing in a 5-year tax-saving FD scheme. Typically, such a scheme helps to save tax under [Section 80C](https://groww.in/p/tax/section-80c) of the ITA.
...
To add to that, you can try [Groww FD Calculator](https://groww.in/calculators/fd-calculator) for computing your returns on FD. It is a user-friendly and super-easy calculator that can assist you to estimate what returns you might receive when you invest a sum in a [fixed deposit](https://groww.in/p/fixed-deposit).
All you need to do is fill in the total investment, rate of interest, and time period in the given fields, and _voila_ , you will get the amount of return calculated in no time!
...
As discussed, check the following beforehand to facilitate a smooth investment experience –
...
_So, before investing in an FD scheme, make sure to find out about this aspect in detail._
  * ### **Taxability**


_Did you know that the interest earned on fixed deposits is fully taxable?_
To elaborate, you will have to pay taxes on FD returns as per your [tax slab](https://groww.in/p/tax/income-tax-slab). Furthermore, if your earnings on FD exceed Rs. 40,000 in a fiscal year, you will have to pay 10% TDS on it.
Notably, for senior citizens, the threshold is Rs. 50,000. In case, your annual income does not come under the [tax](https://groww.in/p/tax) bracket, you can avoid TDS deductions on FD by declaring the same through [Form 15G](https://groww.in/p/savings-schemes/form-15g) or Form 15H (senior citizen).
...
_On that note, make an informed decision in terms of your choice of FD scheme._
  * ### **Suitability**
...
Investing in FDs also has its share of drawbacks, and you need to be aware of them to account for it accordingly.
For instance, the earnings generated on fixed deposits are not inflation-adjusted, and they attract taxation annually. These make a fixed deposit a less attractive avenue for wealth creation. However, FD investments are completely safe and guarantee returns irrespective of the market fluctuations.
## Summing Up
...
---  
1. |  [Best Fixed Deposit to Invest in India](https://groww.in/blog/best-fixed-deposit-in-india)  
2. |  [7 Best Fixed Deposit Strategies to Follow](https://groww.in/blog/best-fixed-deposit-strategies)  
3. |  [Fixed Deposit Tips for Students and Professionals](https://groww.in/blog/fixed-deposit-tips-for-students-and-professionals)  
4. |  [Should I Invest in FD? Where to Invest for Better Returns?](https://groww.in/blog/should-i-invest-in-fd-where-to-invest-for-better-returns)  
5. | [Why Do Indians Prefer Fixed Deposit Investment?](https://groww.in/blog/why-do-indians-prefer-fixed-deposits)  
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[Personal Finance](https://groww.in/blog/category/personal-finance)>How to Invest in Fixed Deposit(FD)
