...
19 February 2025
3 min read
![How to Register a UPI Complaint](https://cms-resources.groww.in/uploads/Groww_Blogs_271124_UPI_Complaint_01_70b4935908.png)
...
The Unified Payments Interface, or UPI, makes real-time financial transactions effortless and seamless. To enhance the user experience, various UPI apps offer 24x7 customer care support. One such relates to filing a **UPI complaint**.
Read on to learn how to raise a complaint on the popular UPI platform and other essential details.
## **Different Types of UPI Issues**
The following are some of the different types of **UPI problems** that you may encounter:
  * ### **Account Issues**


Before making a UPI transaction, you might need to update your account, but you might run into problems here. These can include issues related to changing or removing an account, trouble linking or fetching account details, or challenges faced at the time of deregistering.
  * ### **PIN Issues**


When dealing with [UPI PINs](https://groww.in/banking/what-is-upi-pin), you might face problems such as being unable to set the PIN, getting errors about exceeding PIN attempts, having your PIN blocked, or entering an incorrect PIN. 
  * ### **Processing Issues**


These issues happen when money gets deducted from your account, but the transaction fails. You might also face problems like transactions being sent to the wrong account, transactions pending or declined, thresholds being exceeded, or transactions being timed out.
  * ### **Other Issues**


You might also encounter issues like being unable to log in, failing to register on the app, or facing OTP errors.
## **How to Register a UPI Complaint Online - Stepwise Process**
The following are the steps you need to follow to register a **UPI complaint** :
**Step 1:** Go to the [official website of NPCI](https://www.npci.org.in/).
**Step 2:** Under the ‘What We Do’ tab, click on the ‘UPI’ option and select the ‘Dispute Redressal Mechanism’.
**Step 3:** Scroll down the page and select the ‘Transaction’ option under the ‘Complaint’ section.
**Step 3:** Select the ‘Nature of the transaction’ that matches your complaint.
**Step 4:** Choose the type of issue you are facing, such as account, PIN, registration, transaction, etc., from the options provided on the webpage.
**Step 5:** Enter the bank name, transaction ID, UPI ID, amount, transaction date, and your email ID.
**Step 6:** Provide your registered mobile number and upload a photo of your updated bank account statement.
**Alternatively, you can call on the UPI customer care number** - You can reach out to the UPI helpline number at 18001201740 for any questions or issues. This toll-free number is available 24x7 to assist you.
## **Details Required to File a UPI Complaint**
Here are the details you need to provide to file a **UPI complaint** :
  * **Transaction Details:** Provide the date, time, transaction ID and amount involved.
  * **UPI ID or VPA:** Include the unique identifier for the transaction.
  * **Bank Name and Account Details:** State the name of the bank, account holder’s name and account number. 
  * **Error Messages or Screenshots:** Attach screenshots of any error messages or unusual screens.
  * **Description of the Issue:** Provide a detailed explanation of the problem you encountered.
  * **Contact Information:** Share your name and contact information, including phone number and email address.


## **How to Check the UPI Complaint Status**
To check the status of your**UPI complaint** , follow these easy steps:
**Step 1:** Go to the [NPCI complaint webpage](https://www.npci.org.in/get-in-touch).
**Step 2:** Tap on the 'Click here to check complaint status’ link, then choose your product type and enter your bank details.
**Step 3:** Input your CRN number and the Captcha code.
**Step 4:** Press the 'Get Status' tab to view the status of your complaint.
## **The Bottomline**
Filing a **UPI complaint** is essential for fixing any issues or errors that occur during UPI transactions. By following the steps outlined above, you can effectively register a complaint and seek resolution for various types of UPI problems you may encounter.
Remember to provide accurate details and stay informed about the status of your complaint to ensure a smooth resolution process.
**You may also be interested to know**  
---  
1. | [How to Transfer Money Through UPI?](https://groww.in/blog/how-to-transfer-money-through-upi)  
2. | [What is VPA in UPI: Everything You Must Know](https://groww.in/blog/what-is-vpa-in-upi)  
3. | [How to Secure Your Account from UPI Frauds](https://groww.in/blog/how-to-secure-your-account-from-upi-frauds)  
4. | [How to Track UPI Reference Number?](https://groww.in/blog/how-to-track-upi-reference-number)  
5. | [Cashback Scams In India: How To Stay Safe?](https://groww.in/blog/how-to-stay-safe-from-cashback-scams-in-india)  
...
Related Posts
[Difference Between IMPS and UPI Fund Transfer](https://groww.in/blog/imps-vs-upi)[Difference Between RuPay and Visa Card](https://groww.in/blog/difference-between-rupay-and-visa-card)[Overdraft vs Personal Loan: Which is Better?](https://groww.in/blog/overdraft-vs-personal-loan)[How to Recover Money Transferred to Wrong UPI Address](https://groww.in/blog/how-to-recover-money-transferred-to-wrong-upi-address)[What is VPA in UPI: Everything You Must Know](https://groww.in/blog/what-is-vpa-in-upi)[How to Manage Multiple Credit Cards](https://groww.in/blog/how-to-manage-multiple-credit-cards)[What is a Virtual Credit Card](https://groww.in/blog/what-is-virtual-credit-card)
All Topics
[
