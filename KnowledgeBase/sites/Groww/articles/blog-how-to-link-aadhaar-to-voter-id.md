...
22 May 2023
4 min read
![How to Link Aadhaar Card to Voter ID](https://cms-resources.groww.in/uploads/How_to_Link_Aadhaar_With_Voter_ID_e6665eb805.jpg)
...
Have you been lately thinking about **how to link aadhar to voter id online** or offline? If yes, you have clicked on just the right blog!
Well, a**voter card link with Aadhar** Card is essential and barely requires some effort to get going. It is pretty helpful to get these two IDs linked as they can help you avoid the creation of multiple voter ID cards in a single person’s name.
In this blog, we have covered all the possible ways to get your aadhar link with voter ID. So, without further ado, have a look at the ways here in detail.
## **5 Ways to Link Aadhar to Voter ID**
The easy ways to do voter link with aadhar online and offline are-
**S.No.** |  **Online and Offline Ways**  
---|---  
1. |  Via National Voter Service Portal (NVSP)  
2. |  Via SMS  
3. |  Via Phone  
4. |  Via Voter Helpline App  
5. |  Offline  
Let's look at the above-listed ways in detail here-
### **1) Via National Voter Service Portal (NVSP)**
This is an online way of **Voter Card[Aadhar Card](https://groww.in/p/aadhaar-card) linking**. The steps that you would be required to take to do the **NVSP aadhar link** to voter ID are as follows-
**Step 1:** Open your internet browser and search for [NVSP](https://www.nvsp.in/). Once you open the official portal, click on 'Forms'.
**Step 2:** Search for 'Search Electoral Roll' and click on it.
**Step 3:** You will be redirected to the electoral search form. From the two options, i.e., 'Search by Details' or 'Search by EPIC No.', choose one.
If you choose the 1st option, you will need to fill in your name, age, gender, DOB, assembly constituency, and other relevant details. Else, you can go for the 2nd option, where you can search by EPIC no. and the state.
**Step 4:** Next, fill in the security captcha code and click 'Search.'
**Step 5:** If the filled-in details match the government database, your Voter ID details will be displayed on the next page.
**Step 6** : Next, click on 'Feed Aadhaar No.'
**Step 7** : Here, a pop-up window will appear, where you will need to enter your EPIC number, name, UID number, mobile number, registered email address, etc. Finally, click on 'Submit'.
Once this process is done, you will receive a notification about the successful **Voter ID link with Aadhar**.
### **2) Link Voter ID With Aadhaar Through SMS**
Here is how to link Aadhar to Voter ID by SMS in detail-
**Step 1:** Open your SMS application and type the SMS in the given format
**ECILINK <SPACE><EPIC No. of Voter ID Card No.>< SPACE><Aadhaar No.>**  
---  
**Step 2** : Next, send it to 166 OR 51969 from your registered mobile number.
### **3) Link Aadhaar with Voter ID from Phone**
Linking of the Aadhar and Voter ID can be done by giving a call on 1950 from your registered mobile number between 10-5 PM between Monday to Friday.
A customer care executive would pick up your call to whom you would be required to provide your Aadhaar no. and EPIC number.
After successful verification, the linking will be done. Note you will be intimated about the successful linking of the Aadhaar card & Voter card link via phone.
### **4) Via the Voter Helpline App**
The Voter Helpline App was introduced by the Election Commission of India in order to offer the sole platform for information and service delivery.
You can do the **Adhar link with Voter****card** via this application by following the listed-down steps-
**Step 1:** Open the App Store or Google Play Store on your smartphone and download the Voter Helpline App.
**Step 2:** After setting it up, click on 'Voter Registration'.
**Step 3:** Next, click on Electoral Authentication Form (Form 6B). Following that, select the 'Let's Start' option.
**Step 4:** Next, enter your official mobile number, which is linked to your Aadhaar.
**Step 5:** Fill in the received OTP and press 'Verify'.
**Step 6:** On the next screen, select 'Yes I Have Voter ID' and press 'Next'. Here, enter your Voter ID number (EPIC) and the further details required.
**Step 7:** Select 'Proceed'. Fill in your Aadhaar Card number, place of authentication, and registered mobile number. Next, press 'Done'.
**Step 8:** Make sure to go through the filled-in details and press 'Confirm' to submit Form 6B.
### **5) Link Voter ID With Aadhaar Card Offline**
If you are feeling fuzzy about any of the online processes mentioned above, you can go for the offline process to do the linking too!
Here is how to do the linking Aadhaar card and Voter card offline-
**Step 1:** Find a Booth Level Officer (BLO) who is closest to your residence. It is easy to find one on the [ECI's official website](https://eci.gov.in/).
**Step 2:** Fill in and submit an application to do the Voter card Aadhaar card link.
The BLO will ensure to run a proper verification before linking both IDs.
## **Summing Up**
So this was all about the multiple ways by which you can easily link your Voter ID and Aadhar!
Though the government has stated that it is voluntary and not compulsory to link these two documents, however linking them can help you avoid any fraud, provide you with an acknowledgement that you are a registered voter, and even have it as proof to ascertain your Indian citizenship.
Hence, whichever way you find easy, be it online or offline, just go for the Aadhaar and Voter ID linking soon!
...
3. |  [How To Link Aadhaar Card With Your Mutual Funds](https://groww.in/blog/link-aadhaar-with-your-mutual-funds)  
...
Related Posts
[How to Link Aadhaar Card to LPG Connection](https://groww.in/blog/how-to-link-aadhaar-card-to-lpg-connection)[How to Link Aadhaar with LIC Policy](https://groww.in/blog/how-to-link-aadhaar-with-lic-policy)[How to Link Aadhaar with Driving Licence](https://groww.in/blog/how-to-link-aadhaar-with-driving-licence)[How to Apply for New Aadhar Card Online](https://groww.in/blog/how-to-apply-for-new-aadhar-card-online)[How to Change your Mobile Number in Aadhaar Card?](https://groww.in/blog/how-to-change-your-mobile-number-in-aadhaar-card)
All Topics
[
