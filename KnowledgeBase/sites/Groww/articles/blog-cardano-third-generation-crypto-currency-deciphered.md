...
Ctrl+K
Login/Sign up
# Cardano : Third Generation Crypto Currency Deciphered
28 March 2022
5 min read
![Cardano : Third Generation Crypto Currency Deciphered](https://wp-asset.groww.in/wp-content/uploads/2018/01/18123520/Cardano-Third-Generation-Crypto-Currency-Deciphered.025.jpeg)
...
Since then, the [cryptocurrency](https://groww.in/p/cryptocurrency) has jumped by 1,520%. With a market capitalization of $18.8 billion, Cardano is the fifth-most valuable cryptocurrency as of this writing.
## **History of Cardano**
After launching in September 2017, Cardano’s ADA token mostly remained under the radar of traders until the end of November.
...
## **Cardano Rate Chart**
[![](https://wp-asset.groww.in/wp-content/uploads/2018/01/18123520/cardano-1-1024x681.png)](https://wp-asset.groww.in/wp-content/uploads/2018/01/18123520/cardano-1.png)
## **Cardano Facts**
...
## **Characteristics**
  ...
  2. ADA calls itself the first third-generation cryptocurrency and aims to tackle the scaling and infrastructure problems of bitcoin and Ethereum. Specifically, Cardano aims to solve problems related to scalability, interoperability, and sustainability on cryptocurrency platforms.
...
Further, the entire concept of cryptocurrencies is in a state of infancy right now. The cryptocurrencies are being transactional purpose and not for people to make capital gains by trading them on the stock exchange.
Critics have charged that an approach modeled on Proof of Stake could end up as a plutocracy, where nodes with the highest stakes would run the show.
...
Still, if you want easy returns and are open to risk then you can try investing in small-cap funds which is still better than diving into the uncharted waters of cryptocurrency.
## **Cardano Risk**
...
Hoskinson has said that its data scaling efforts will not bear fruit until 2019. Several innovations in the system, such as its aim of standardizing protocols, are still in the research phase and will be implemented only as Cardano’s use cases grow. In its current state, Cardano’s technology is also unproven.
## **Conclusion**
