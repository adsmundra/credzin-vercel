...
17 April 2025
4 min read
![What is Book Building Process in IPO](https://cms-resources.groww.in/uploads/pexels_weekendplayer_186461_1_11zon_77f3a532da.jpg)
...
### **Step 2: Bidding**
The underwriter, along with the issuer, invites investors to submit bids for the shares being sold through the [IPO](https://groww.in/ipo) based on the given price range.
...
Once all bids are received, the IPO price is finalised. Investors whose bids meet or exceed the cut-off price are allotted [shares](https://groww.in/stocks). Those who bid above the cut-off receive a refund for the excess amount.
...
The [Securities and Exchange Board of India](https://groww.in/p/sebi-securities-and-exchange-board-of-india) (SEBI) provides clear guidelines for the **Book Building process in IPOs** , ensuring it is well-regulated and structured. This regulatory support promotes fairness and transparency throughout the process.
...
**Read more:** [What is IPO Listing Time?](https://groww.in/blog/ipo-listing-time)
...
Since this process is based on demand, it lowers marketing expenses. However, companies will still need to compensate [underwriters](https://groww.in/p/underwriter) for their services.
## **The Bottomline**
...
4. | [How Long Should You Hold a Stock](https://groww.in/blog/how-long-should-you-hold-a-stock)  
...
[Home](https://groww.in/)>[Blog](https://groww.in/blog)>[IPO](https://groww.in/blog/category/ipo)>What is Book Building Process in IPO
