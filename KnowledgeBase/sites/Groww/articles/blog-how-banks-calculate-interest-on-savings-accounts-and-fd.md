...
05 June 2024
4 min read
![How do Banks Calculate Interest on Savings accounts & FD in India?](https://cms-resources.groww.in/uploads/Interest_calculation_80637bdcad.jpeg)
...
You might wonder, how is interest calculated on savings account. Well, interest calculation on Savings Accounts has become much simpler after 2010. 
### **Pre-2010**
...
---|---|---|---|---  
**01-May-2022** |  200,000 |  - |  - |  200,000  
**06-May-2022** |  200,000 |  - |  60,000 |  140,000  
**10-May-2022** |  140,000 |  40,000 |  - |  180,000  
**20-May-2022** |  180,000 |  20,000 |  5,000 |  195,000  
**31-May-2022** |  195,000 |  - |  - |  195,000  
...
Therefore,
[Savings Account](https://groww.in/savings-account) Interest for these 5 days=200000 ×4 ×5365 ×100=Rs.109.59
...
**Here is a summary:**
**Closing Balance (Rs.)** |  **Number of Days** |  **Interest Earned (Rs.)**  
---|---|---  
**200,000** |  5 |  109.59  
**140,000** |  4 |  61.37  
**180,000** |  10 |  197.26  
...
Calculation of interest on [Fixed Deposits](https://groww.in/fixed-deposit) is relatively simpler if they are held until maturity. However, if you prematurely withdraw the FD, then the bank can levy a penal interest. Let’s understand these interest calculations with the help of an example.
...
Also, check out the **[FD Interest rate calculator](https://groww.in/calculators/fd-calculator) **if you are planning to invest in FD.
## **Summing Up**
So this was all about how banks calculate interest on savings accounts and fixed deposits.
While most investors rely on the bank to calculate interest efficiently, it is important to understand the calculation to have a complete grip over your deposits. There are many online calculators that can help you find the interest on your Savings or Fixed Deposit Accounts.
**You May Also Be Interested to Know**  
---  
1. |  [What is an Investment Bank and How Does it Work?](https://groww.in/blog/how-does-investment-bank-work)  
2. |  [How Do Banks Make Money?](https://groww.in/blog/how-do-banks-make-money)  
3. |  [Types of Banking Frauds - How to Prevent Them](https://groww.in/blog/types-of-banking-frauds)  
4. |  [Digital Banking: Types and Services Offered](https://groww.in/banking/digital-banking)  
5. | [What is a Bad Bank? Will it Help Investors and Depositors?](https://groww.in/blog/what-is-a-bad-bank)  
