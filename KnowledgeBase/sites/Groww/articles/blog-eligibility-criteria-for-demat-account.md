...
17 June 2025
2 min read
![Eligibility Criteria and Documents Required to open Demat Account](https://cms-resources.groww.in/uploads/Eligibility_Criteria_for_Demat_Account_11zon_a40014dd37.jpg)
...
The first step in your investing and trading journey is opening a demat account. It holds all your securities (stocks, bonds, mutual funds, etc.) in a single consolidated electronic format. If you’re a new investor, understanding the prerequisites and eligibility criteria for a demat account is crucial. 
...
The entities below are eligible to open a demat account. 
  ...
  * [**Hindustan Undivided Family**](https://groww.in/blog/what-is-huf-and-benefits) (HUFs)
  * [**Corporate Demat Account**](https://groww.in/blog/corporate-demat-and-trading-account) for 
    * Partnership Firms,
...
_***Disclaimer: Groww, at present, does not facilitate Demat Account opening for NRIs and Minors.**_
## **Documents Required To Open a Demat Account**
As per [**SEBI guidelines**](https://investor.sebi.gov.in/pdf/reference-material/ppt/PPT-2%20KYC%20Procedure%20Updated%2030%20Sep%202022.pdf) , the documents below are required for the demat account opening process. 
  * ### **Identity Proof**
...
You can open a [**demat account online**](https://groww.in/open-demat-account) via 
