...
class NotificationService {
  ...
  async createNotification(userId, type, title, message, channels = {}, metadata = {}) {
    try {
  ...
  async sendNotification(userId, type, title, message, channels = {}, metadata = {}) {
    try {
      // Create notification in database
      const notification = await this.createNotification(userId, type, title, message, channels, metadata);
