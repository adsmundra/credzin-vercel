...
19 April 2022
3 min read
![फ़्यूचर्स और ऑप्शन्स के बीच अंतर](https://wp-asset.groww.in/wp-content/uploads/2022/04/18133812/entrepreneur-g023a76ed1_1280.jpg)
...
फ्यूचर और ऑप्शन्स के बीच अंतर जानने से पहले यह जान लेना आवश्यक है की फ्यूचर एंड ऑप्शंस क्या हैं। 
फ़्यूचर्स और ऑप्शंस बायर और सेलर के बीच, भविष्य में, पहले से तय मूल्य पर, स्टॉक एसेट के व्यापार के लिए साइंड कॉन्ट्रैक्ट्स होते हैं। इस तरह के कॉन्ट्रैक्ट्स, पहले से ही तय मूल्य को लॉक करके, [स्टॉक](https://groww.in/stocks) मार्केट ट्रेडिंग में शामिल बाजार रिस्क्स को हेज करने की कोशिश करते हैं।
शेयर बाजार में [फ़्यूचर्स और ऑप्शंस](https://groww.in/futures-and-options) ऐसे कॉन्ट्रैक्ट्स हैं जो एक अंडरलाइंग एसेट से अपनी कीमत प्राप्त (डीराइव) करते हैं, जैसे शेयर, स्टॉक मार्केट इंडेक्स, कमोडिटी, ईटीएफ, और बहुत कुछ ।
डीराइवड वैल्यू क्या है ? सरल भाषा में बोला जाये तो किसी एसेट के वज़ह से मिलने वाला कीमत को डीराइवड वैल्यू कहा जा सकता है। 
...
एक [**ऑप्शंस**](https://groww.in/p/option-trading) कॉन्ट्रैक्ट खरीदार को एक निश्चित कीमत पर संपत्ति खरीदने का अधिकार देता है। हालांकि, खरीदने के लिए खरीदार की ओर से कोई दायित्व (ऑब्लिगेशन) नहीं है। मगर फिर भी, अगर खरीदार संपत्ति खरीदना चाहे, तो विक्रेता इसे बेचने के लिए बाध्य है।
  * ### जोखिम (रिस्क)
...
## **संक्षेप में:**
### **फ्यूचर्स कॉन्ट्रैक्ट में:**
  1. खरीदार कॉन्ट्रैक्ट का सम्मान करने के लिए बाध्य है। 
  2. यदि खरीदार अपना अधिकार प्रयोग करता है तो कॉन्ट्रैक्ट के अनुसार विक्रेता (सेलर) को बेचने/खरीदने का दायित्व पालन करना ज़रूरी है।
  3. ऑप्शंस की तुलना में अधिक मार्जिन पेमेंट की आवश्यकता होती है।
  4. असीमित लाभ हानि की सम्भावना रहती है। 


### **ऑप्शंस में:**
  1. खरीदार पर वास्तव में खरीदने या बेचने का कोई दायित्व नहीं है।
  2. यदि खरीदार अधिकार प्रयोग करता है तो कॉन्ट्रैक्ट में सेलर को बेचने/खरीदने का दायित्व पालन करना है।
  3. फ्यूचर्स की तुलना में कम मार्जिन पे करने की आवश्यकता है।
  4. हेजर्स (Hedgers) द्वारा पसंद किया गया जाता है ।
  5. असीमित (अनलिमिटेड) लाभ सीमित (लिमिटेड) हानि की सम्भावना रहती है। 
