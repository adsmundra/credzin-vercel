...
19 February 2025
4 min read
![What is a Basis Point \(BPS\)](https://cms-resources.groww.in/uploads/Groww_Blogs_271124_BPS_01_b8f4fdbce1.png)
...
Interest rate changes on [credit cards](https://groww.in/credit-card) can be communicated and analysed using basis points.
  * ### **Futures and Options**


In stock market derivatives like [futures and options](https://groww.in/futures-and-options), basis points measure the changes in return rates. 
...
Now that you have learnt basis points meaning, let's have a look at some benefits of using the basis points system:
  ...
  * Basis points help investors track changes in [stock indices](https://groww.in/indices).
...
Lenders often express interest rates in basis points. This helps borrowers compare [loan](https://groww.in/loans) options to zero in on the most cost-effective option.
  * ### **Risk Management**
...
2. | [Difference Between FERA and FEMA](https://groww.in/blog/difference-between-fera-and-fema)  
3. | [Financial Regulatory Bodies in India](https://groww.in/blog/financial-regulatory-bodies-in-india)  
