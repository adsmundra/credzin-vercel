...
13 June 2023
4 min read
![What Should You Do in Case of a Mutual Fund Merger?](https://cms-resources.groww.in/uploads/What_Should_You_Do_in_Case_of_a_Mutual_Fund_Merger_ad4dce51d7.jpg)
...
[Mutual Funds](https://groww.in/mutual-funds) are ideal for investors who want to buy such securities but lack the time or knowledge to do so. Professionals are in charge of managing these funds, strategically allocating the money for the benefit of the investors' capital gains and income.
In order to bring consistency among similar schemes introduced by the various Mutual Fund Houses, SEBI (the [Securities and Exchange Board of India](https://groww.in/p/sebi-securities-and-exchange-board-of-india)) introduced new and broad categories for Mutual Funds in October 2017.
...
The regulatory guidelines by SEBI, which prohibit [asset management companies](https://groww.in/mutual-funds/amc) (AMCs) from having overlapping, similar schemes to avoid clutter for investors, are one of the main causes of **MF Mergers** in India.
...
Redeem your investment and transfer the corpus to another successful fund with the same sector or theme if you have a solid, favourable opinion of the sector's or theme's performance.
  * ### **Insufficient & Inadequate Performance**
...
## **SEBI’s Prominent Regulations in Case of a Mutual Fund Merger**
  1. Investors should be given the option to leave with a 30-day notice period.
  2. To enable investors to make a well-informed decision, the following pertinent information should be provided:


  * The most recent portfolio of the schemes in question.
  * Information on the financial performance of the aforementioned schemes since they were first implemented, along with comparisons to relevant benchmarks.
  * Details on the new combined scheme's key characteristics, asset allocation, and investment objective.


  * Grounds for allocating new units using a numerical example.


  * Proportions of total non-performing assets and total liquid assets compared to net assets for each scheme and the consolidated scheme.


  * The unitholders' tax consequences of the consolidation.


  * Additional disclosures that the Trustees may require.


  * Additional disclosures that the Board may require.


  1. Investors are not required to pay an exit load if they decide to exit.
...
To determine whether the new mandate meets their investment needs, one must examine the new or transferee scheme's achievement, strategic planning, and investment philosophy.
  * ### **Verify Any Potential Tax Consequences Following the Merger**


Read up on the merger's methodology and keep a close eye on any possible tax repercussions.
  * ### **Watch Carefully for Any Fee Adjustments**
